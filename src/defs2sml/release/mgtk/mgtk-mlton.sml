...
val get_accel_flags_ : int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_accel_flags" : int ref * int ref * int ref -> unit;
val (ACCEL_VISIBLE, ACCEL_LOCKED, ACCEL_MASK)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_accel_flags_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
type celltype = int
...
val (CELL_EMPTY, CELL_TEXT, CELL_PIXMAP, CELL_PIXTEXT, CELL_WIDGET)
    = let val (x0, x1, x2, x3, x4) = (ref 0, ref 0, ref 0, ref 0, ref 0)
      in
	get_celltype_ (x0, x1, x2, x3, x4); (! x0, ! x1, ! x2, ! x3, ! x4) 
      end
type debug_flag = int
val get_debug_flag_ : int ref * int ref * int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_debug_flag"
	      : int ref * int ref * int ref * int ref * int ref -> unit;
val (DEBUG_MISC, DEBUG_PLUGSOCKET, DEBUG_TEXT, DEBUG_TREE, DEBUG_UPDATES)
    = let val (x0, x1, x2, x3, x4) = (ref 0, ref 0, ref 0, ref 0, ref 0)
      in
	get_debug_flag_ (x0, x1, x2, x3, x4); (! x0, ! x1, ! x2, ! x3, ! x4) 
      end
...
val get_responsetype_
  ...
  * int ref * int ref * int ref * int ref
    ...
    = _import "mgtk_get_gtk_responsetype"
		...
		-> unit;
val (RESPONSE_NONE, RESPONSE_REJECT, RESPONSE_ACCEPT, RESPONSE_DELETE_EVENT, 
     RESPONSE_OK, RESPONSE_CANCEL, RESPONSE_CLOSE, RESPONSE_YES, RESPONSE_NO, 
     RESPONSE_APPLY, RESPONSE_HELP)
...
val (DEST_DEFAULT_MOTION, DEST_DEFAULT_HIGHLIGHT, DEST_DEFAULT_DROP, 
    ...
    = let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
      in get_dest_defaults_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
...
val (TARGET_SAME_APP, TARGET_SAME_WIDGET)
    = let val (x0, x1) = (ref 0, ref 0)
      in get_target_flags_ (x0, x1); (! x0, ! x1)  end
type anchortype = int
...
val (ANCHOR_CENTER, ANCHOR_NORTH, ANCHOR_NORTH_WEST, ANCHOR_NORTH_EAST, 
    ...
    = let val (x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, 
      ...
      in get_anchortype_ (x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, 
			  x12, x13, x14, x15, x16); 
	 (! x0, ! x1, ! x2, ! x3, ! x4, ! x5, ! x6, ! x7, ! x8, ! x9, ! x10, 
...
val (ARROW_UP, ARROW_DOWN, ARROW_LEFT, ARROW_RIGHT)
    = let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
      in get_arrowtype_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
...
val (EXPAND, SHRINK, FILL)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_attach_options_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
type curvetype = int
val get_curvetype_ : int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_curvetype" : int ref * int ref * int ref -> unit;
val (CURVE_TYPE_LINEAR, CURVE_TYPE_SPLINE, CURVE_TYPE_FREE)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_curvetype_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
type deletetype = int
...
val (EXPANDER_COLLAPSED, EXPANDER_SEMI_COLLAPSED, EXPANDER_SEMI_EXPANDED, 
     EXPANDER_EXPANDED)
    = let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
      in get_expander_style_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
type icon_size = int
val get_icon_size_
  : int ref * int ref * int ref * int ref * int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_icon_size" : int ref * int ref * int ref * int ref 
				       * int ref * int ref * int ref
					 -> unit;
...
val (SIDE_TOP, SIDE_BOTTOM, SIDE_LEFT, SIDE_RIGHT)
    = let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
      in get_sidetype_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
...
val (TEXT_DIR_NONE, TEXT_DIR_LTR, TEXT_DIR_RTL)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_text_direction_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
...
val (JUSTIFY_LEFT, JUSTIFY_RIGHT, JUSTIFY_CENTER, JUSTIFY_FILL)
    = let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
      in get_justification_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
type matchtype = int
val get_matchtype_
  : int ref * int ref * int ref * int ref * int ref * int ref -> unit
...
val get_metrictype_ : int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_metrictype" : int ref * int ref * int ref -> unit;
val (PIXELS, INCHES, CENTIMETERS)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_metrictype_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
...
val get_movement_step_ : int ref * int ref * int ref * int ref * int ref 
    ...
    = _import "mgtk_get_gtk_movement_step" : int ref * int ref * int ref 
					   ...
					   * int ref * int ref * int ref
					     -> unit;
val (MOVEMENT_LOGICAL_POSITIONS, MOVEMENT_VISUAL_POSITIONS, MOVEMENT_WORDS, 
     MOVEMENT_DISPLAY_LINES, MOVEMENT_DISPLAY_LINE_ENDS, MOVEMENT_PARAGRAPHS, 
...
val (ORIENTATION_HORIZONTAL, ORIENTATION_VERTICAL)
    = let val (x0, x1) = (ref 0, ref 0)
      in get_orientation_ (x0, x1); (! x0, ! x1)  end
type cornertype = int
...
val (CORNER_TOP_LEFT, CORNER_BOTTOM_LEFT, CORNER_TOP_RIGHT, 
     CORNER_BOTTOM_RIGHT)
    = let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
      in get_cornertype_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
type packtype = int
...
val (PACK_START, PACK_END) = let val (x0, x1) = (ref 0, ref 0)
			     in get_packtype_ (x0, x1); (! x0, ! x1)  end
...
val get_path_prioritytype_
  : int ref * int ref * int ref * int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_path_prioritytype"
	      : int ref * int ref * int ref * int ref * int ref * int ref
		-> unit;
val (PATH_PRIO_LOWEST, PATH_PRIO_GTK, PATH_PRIO_APPLICATION, PATH_PRIO_THEME, 
     PATH_PRIO_RC, PATH_PRIO_HIGHEST)
    = let val (x0, x1, x2, x3, x4, x5)
	      = (ref 0, ref 0, ref 0, ref 0, ref 0, ref 0)
...
val get_pathtype_ : int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_pathtype" : int ref * int ref * int ref -> unit;
val (PATH_WIDGET, PATH_WIDGET_CLASS, PATH_CLASS)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_pathtype_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
type policytype = int
val get_policytype_ : int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_policytype" : int ref * int ref * int ref -> unit;
val (POLICY_ALWAYS, POLICY_AUTOMATIC, POLICY_NEVER)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_policytype_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
...
val (POS_LEFT, POS_RIGHT, POS_TOP, POS_BOTTOM)
    = let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
      in get_positiontype_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
...
val (PREVIEW_COLOR, PREVIEW_GRAYSCALE)
    = let val (x0, x1) = (ref 0, ref 0)
      in get_previewtype_ (x0, x1); (! x0, ! x1)  end
...
val (RELIEF_NORMAL, RELIEF_HALF, RELIEF_NONE)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_relief_style_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
type resize_mode = int
val get_resize_mode_ : int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_resize_mode" : int ref * int ref * int ref -> unit;
val (RESIZE_PARENT, RESIZE_QUEUE, RESIZE_IMMEDIATE)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_resize_mode_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
type scrolltype = int
...
val (SCROLL_NONE, SCROLL_JUMP, SCROLL_STEP_BACKWARD, SCROLL_STEP_FORWARD, 
    ...
    = let val (x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, 
	      ...
	      = (ref 0, ref 0, ref 0, ref 0, ref 0, ref 0, ref 0, ref 0, 
		 ref 0, ref 0, ref 0, ref 0, ref 0, ref 0, ref 0, ref 0)
      in get_scrolltype_ (x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, 
			  x12, x13, x14, x15); 
	 (! x0, ! x1, ! x2, ! x3, ! x4, ! x5, ! x6, ! x7, ! x8, ! x9, ! x10, 
	  ! x11, ! x12, ! x13, ! x14, ! x15)
...
val get_selection_mode_ : int ref * int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_selection_mode"
	      : int ref * int ref * int ref * int ref -> unit;
val (SELECTION_NONE, SELECTION_SINGLE, SELECTION_BROWSE, SELECTION_MULTIPLE)
    = let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
      in get_selection_mode_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
type shadowtype = int
val get_shadowtype_ : int ref * int ref * int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_shadowtype"
	      : int ref * int ref * int ref * int ref * int ref -> unit;
val (SHADOW_NONE, SHADOW_IN, SHADOW_OUT, SHADOW_ETCHED_IN, SHADOW_ETCHED_OUT)
    = let val (x0, x1, x2, x3, x4) = (ref 0, ref 0, ref 0, ref 0, ref 0)
      in
	get_shadowtype_ (x0, x1, x2, x3, x4); (! x0, ! x1, ! x2, ! x3, ! x4) 
      end
type statetype = int
val get_statetype_ : int ref * int ref * int ref * int ref * int ref -> unit
...
val (STATE_NORMAL, STATE_ACTIVE, STATE_PRELIGHT, STATE_SELECTED, 
    ...
    = let val (x0, x1, x2, x3, x4) = (ref 0, ref 0, ref 0, ref 0, ref 0)
      in
	get_statetype_ (x0, x1, x2, x3, x4); (! x0, ! x1, ! x2, ! x3, ! x4) 
      end
...
val (DIRECTION_LEFT, DIRECTION_RIGHT)
    = let val (x0, x1) = (ref 0, ref 0)
      in get_submenu_direction_ (x0, x1); (! x0, ! x1)  end
...
val (TOP_BOTTOM, LEFT_RIGHT)
    = let val (x0, x1) = (ref 0, ref 0)
      in get_submenu_placement_ (x0, x1); (! x0, ! x1)  end
type updatetype = int
val get_updatetype_ : int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_updatetype" : int ref * int ref * int ref -> unit;
val (UPDATE_CONTINUOUS, UPDATE_DISCONTINUOUS, UPDATE_DELAYED)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_updatetype_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
type visibility = int
val get_visibility_ : int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_visibility" : int ref * int ref * int ref -> unit;
val (VISIBILITY_NONE, VISIBILITY_PARTIAL, VISIBILITY_FULL)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_visibility_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
type wrap_mode = int
val get_wrap_mode_ : int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_wrap_mode" : int ref * int ref * int ref -> unit;
val (WRAP_NONE, WRAP_CHAR, WRAP_WORD)
    = let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
      in get_wrap_mode_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
type sorttype = int
...
val (SORT_ASCENDING, SORT_DESCENDING)
    = let val (x0, x1) = (ref 0, ref 0)
      in get_sorttype_ (x0, x1); (! x0, ! x1)  end
type imagetype = int
val get_imagetype_
  : int ref * int ref * int ref * int ref * int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_imagetype" : int ref * int ref * int ref * int ref 
				       * int ref * int ref * int ref
					 -> unit;
...
val (MESSAGE_INFO, MESSAGE_WARNING, MESSAGE_QUESTION, MESSAGE_ERROR)
    = let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
      in get_messagetype_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
type buttonstype = int
val get_buttonstype_
  : int ref * int ref * int ref * int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_buttonstype" : int ref * int ref * int ref 
					 * int ref * int ref * int ref
					   -> unit;
val (BUTTONS_NONE, BUTTONS_OK, BUTTONS_CLOSE, BUTTONS_CANCEL, BUTTONS_YES_NO, 
     BUTTONS_OK_CANCEL)
    = let val (x0, x1, x2, x3, x4, x5)
	      = (ref 0, ref 0, ref 0, ref 0, ref 0, ref 0)
...
type arg_flags = int
val get_arg_flags_ : int ref * int ref * int ref * int ref * int ref -> unit
...
val (ARG_READABLE, ARG_WRITABLE, ARG_CONSTRUCT, ARG_CONSTRUCT_ONLY, 
    ...
    = let val (x0, x1, x2, x3, x4) = (ref 0, ref 0, ref 0, ref 0, ref 0)
      in
	get_arg_flags_ (x0, x1, x2, x3, x4); (! x0, ! x1, ! x2, ! x3, ! x4) 
      end
type rc_flags = int
...
val (RC_FG, RC_BG, RC_TEXT, RC_BASE)
    = let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
      in get_rc_flags_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
...
val get_rc_tokentype_
  ...
  * int ref * int ref * int ref
    ...
    = _import "mgtk_get_gtk_rc_tokentype"
	      ...
	      * int ref * int ref
		-> unit;
val (RC_TOKEN_INVALID, RC_TOKEN_INCLUDE, RC_TOKEN_NORMAL, RC_TOKEN_ACTIVE, 
     ...
     RC_TOKEN_BINDING, RC_TOKEN_BIND, RC_TOKEN_WIDGET, RC_TOKEN_WIDGET_CLASS, 
     RC_TOKEN_CLASS, RC_TOKEN_LOWEST, RC_TOKEN_GTK, RC_TOKEN_APPLICATION, 
     RC_TOKEN_THEME, RC_TOKEN_RC, RC_TOKEN_HIGHEST, RC_TOKEN_ENGINE, 
     RC_TOKEN_MODULE_PATH, RC_TOKEN_IM_MODULE_PATH, RC_TOKEN_IM_MODULE_FILE, 
     RC_TOKEN_STOCK, RC_TOKEN_LTR, RC_TOKEN_RTL, RC_TOKEN_LAST)
    = let val (x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, 
...
val get_spintype_
  : int ref * int ref * int ref * int ref * int ref * int ref * int ref -> unit
    = _import "mgtk_get_gtk_spintype" : int ref * int ref * int ref * int ref 
				      * int ref * int ref * int ref
					-> unit;
...
val (TEXT_SEARCH_VISIBLE_ONLY, TEXT_SEARCH_TEXT_ONLY)
    = let val (x0, x1) = (ref 0, ref 0)
      in get_text_search_flags_ (x0, x1); (! x0, ! x1)  end
...
val (TEXT_WINDOW_PRIVATE, TEXT_WINDOW_WIDGET, TEXT_WINDOW_TEXT, 
     TEXT_WINDOW_LEFT, TEXT_WINDOW_RIGHT, TEXT_WINDOW_TOP, TEXT_WINDOW_BOTTOM)
    = let val (x0, x1, x2, x3, x4, x5, x6)
	      = (ref 0, ref 0, ref 0, ref 0, ref 0, ref 0, ref 0)
...
val icon_size_register_alias_ : CString.cstring * int -> unit
    = _import "gtk_icon_size_register_alias" : CString.cstring * int -> unit;
...
val icon_size_get_name : icon_size -> string
    = fn size => let val t = icon_size_get_name_ size in CString.toString t end
val icon_set_new_ : unit -> cptr = _import "gtk_icon_set_new" : unit -> cptr;
val icon_set_new : unit -> icon_set = fn dummy => icon_set_new_ dummy
val icon_source_get_type_ : unit -> int
    = _import "gtk_icon_source_get_type" : unit -> int;
val icon_source_get_type : unit -> int
...
val events_pending_ : unit -> int = _import "gtk_events_pending" : unit -> int;
...
val border_get_type_ : unit -> int
    = _import "gtk_border_get_type" : unit -> int;
val border_get_type : unit -> int = fn dummy => border_get_type_ dummy
val tips_query_get_type_ : unit -> int
    = _import "gtk_tips_query_get_type" : unit -> int;
val tips_query_get_type : unit -> int = fn dummy => tips_query_get_type_ dummy
val tree_path_new_ : unit -> cptr = _import "gtk_tree_path_new" : unit -> cptr;
...
val requisition_get_type_ : unit -> int
    = _import "gtk_requisition_get_type" : unit -> int;
val requisition_get_type : unit -> int
    = fn dummy => requisition_get_type_ dummy
signature AccelGroup = sig
    type base
    type 'a accelgroup_t
    ...
    val accel_activate_sig : (unit -> int -> unit -> bool)
			     -> 'a t Signal.signal
    val accel_changed_sig : (int -> unit -> unit -> unit) -> 'a t Signal.signal
end
structure AccelGroup :> AccelGroup = struct
    type cptr = GObject.cptr
    type base = unit
	...
	= _import "gtk_accel_group_get_type" : unit -> int;
    ...
    val lock_ : cptr -> unit = _import "gtk_accel_group_lock" : cptr -> unit;
    val lock : 'a t -> unit
...
structure IconFactory :> IconFactory = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toIconFactory obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_icon_factory_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_icon_factory_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
	...
	= fn self => fn stock_id => fn icon_set =>
	     GObject.withPtr
	       (self, 
		fn self => add_ (self, CString.fromString stock_id, icon_set))
    val lookup_ : cptr * CString.cstring -> cptr
	= _import "gtk_icon_factory_lookup" : cptr * CString.cstring -> cptr;
    val lookup : 'a t -> string -> icon_set
	= fn self => fn stock_id =>
	     GObject.withPtr
	       (self, fn self => lookup_ (self, CString.fromString stock_id))
    ...
    val remove_default : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => remove_default_ self)
    val lookup_default_ : CString.cstring -> cptr
	= _import "gtk_icon_factory_lookup_default" : CString.cstring -> cptr;
    val lookup_default : string -> icon_set
...
structure Object :> Object = struct
	...
	= let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
	  in get_flags_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
    val get_type_ : unit -> int = _import "gtk_object_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : int * CString.cstring -> cptr
	= _import "gtk_object_new" : int * CString.cstring -> cptr;
    val new : int -> string -> base t
    ...
    val destroy_ : cptr -> unit = _import "gtk_object_destroy" : cptr -> unit;
    val destroy : 'a t -> unit
...
structure Adjustment :> Adjustment = struct
    ...
    fun toAdjustment obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_adjustment_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val new : real option -> real option -> real option -> real option 
	   -> real option -> real option
	      -> base t
	= fn value => fn lower => fn upper => fn step_incr => fn page_incr => 
	  fn page_size =>
...
signature Widget = sig
    ...
    val size_request : 'a t -> requisition -> unit
    ...
    val get_ancestor : 'a t -> int -> base t
    ...
    val selection_received_sig : (unit -> int -> unit) -> 'a t Signal.signal
    val selection_get_sig : (unit -> int -> int -> unit) -> 'a t Signal.signal
...
structure Widget :> Widget = struct
    ...
    fun toWidget obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    type flags = int
    val get_flags_ : int ref * int ref * int ref * int ref * int ref * int ref 
		   * int ref * int ref * int ref * int ref * int ref * int ref 
		   * int ref * int ref * int ref * int ref * int ref * int ref
		     -> unit
	...
	= _import "mgtk_get_gtk_widget_helptype" : int ref * int ref -> unit;
    val (HELP_TOOLTIP, HELP_WHATS_THIS)
	= let val (x0, x1) = (ref 0, ref 0)
	  in get_helptype_ (x0, x1); (! x0, ! x1)  end
    ...
    val drag_highlight : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => drag_highlight_ self)
    val drag_unhighlight_ : cptr -> unit
	= _import "gtk_drag_unhighlight" : cptr -> unit;
    val drag_unhighlight : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => drag_unhighlight_ self)
    val drag_dest_unset_ : cptr -> unit
	= _import "gtk_drag_dest_unset" : cptr -> unit;
    val drag_dest_unset : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => drag_dest_unset_ self)
    val drag_source_unset_ : cptr -> unit
	= _import "gtk_drag_source_unset" : cptr -> unit;
    val drag_source_unset : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => drag_source_unset_ self)
    ...
    val grab_remove_ : cptr -> unit = _import "gtk_grab_remove" : cptr -> unit;
    val grab_remove : 'a t -> unit
    ...
    val get_type_ : unit -> int = _import "gtk_widget_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : int * CString.cstring -> cptr
	= _import "gtk_widget_new" : int * CString.cstring -> cptr;
    val new : int -> string -> base t
	= fn typ => fn first_property_name =>
	     make (new_ (typ, CString.fromString first_property_name))
    ...
    val destroy_ : cptr -> unit = _import "gtk_widget_destroy" : cptr -> unit;
    val destroy : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => destroy_ self)
	...
	= fn self => fn first_property_name =>
	     GObject.withPtr
	       (self, 
		fn self => set_ (self, CString.fromString first_property_name))
    ...
    val realize_ : cptr -> unit = _import "gtk_widget_realize" : cptr -> unit;
    val realize : 'a t -> unit
	...
	= fn self => fn x => fn y => fn width => fn height =>
	     GObject.withPtr
	       (self, fn self => queue_draw_area_ (self, x, y, width, height))
	...
	= fn self => fn x => fn y => fn width => fn height =>
	     GObject.withPtr
	       (self, fn self => queue_clear_area_ (self, x, y, width, height))
    ...
    val size_request_ : cptr * cptr -> unit
	= _import "gtk_widget_size_request" : cptr * cptr -> unit;
    val size_request : 'a t -> requisition -> unit
	= fn self => fn requisition =>
	     GObject.withPtr
	       (self, fn self => size_request_ (self, requisition))
    val get_child_requisition_ : cptr * cptr -> unit
	= _import "gtk_widget_get_child_requisition" : cptr * cptr -> unit;
    val get_child_requisition : 'a t -> requisition -> unit
	= fn self => fn requisition =>
	     GObject.withPtr
	       (self, fn self => get_child_requisition_ (self, requisition))
	...
	= fn self => fn new_parent =>
		...
		fn self => GObject.withPtr
			     (new_parent, 
			      fn new_parent => reparent_ (self, new_parent)))
	...
	= _import "gtk_widget_child_notify" : cptr * CString.cstring -> unit;
    val child_notify : 'a t -> string -> unit
    ...
    val thaw_child_notify : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => thaw_child_notify_ self)
	...
	= fn self => fn double_buffered =>
	     GObject.withPtr
	       (self, fn self => set_double_buffered_ (self, double_buffered))
    val set_redraw_on_allocate_ : cptr * bool -> unit
	= _import "gtk_widget_set_redraw_on_allocate" : cptr * bool -> unit;
    val set_redraw_on_allocate : 'a t -> bool -> unit
    ...
    val get_child_visible : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_child_visible_ self)
    val get_parent_ : cptr -> cptr
	= _import "gtk_widget_get_parent" : cptr -> cptr;
    val get_parent : 'a t -> base t
	= fn self => make (GObject.withPtr (self, fn self => get_parent_ self))
    val child_focus_ : cptr * int -> bool
	= _import "gtk_widget_child_focus" : cptr * int -> bool;
    val child_focus : 'a t -> directiontype -> bool
	= fn self => fn direction =>
	     GObject.withPtr (self, fn self => child_focus_ (self, direction))
    ...
    val get_ancestor_ : cptr * int -> cptr
	= _import "gtk_widget_get_ancestor" : cptr * int -> cptr;
    val get_ancestor : 'a t -> int -> base t
	...
	= fn self => fn ancestor =>
		...
		fn self => GObject.withPtr
			     (ancestor, 
			      fn ancestor => is_ancestor_ (self, ancestor)))
    val hide_on_delete_ : cptr -> bool
	= _import "gtk_widget_hide_on_delete" : cptr -> bool;
    val hide_on_delete : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => hide_on_delete_ self)
    ...
    val get_style : 'a t -> base t
	= fn self => make (GObject.withPtr (self, fn self => get_style_ self))
    ...
    val reset_rc_styles : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => reset_rc_styles_ self)
	...
	= fn self => fn first_property_name =>
	     GObject.withPtr
	       (self, 
		fn self => style_get_
			     (self, CString.fromString first_property_name))
    ...
    in
      ...
      val hierarchy_changed_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "hierarchy-changed" false (unit --> return_void) f
      val style_set_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "style-set" false (unit --> return_void) f
      val direction_changed_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "direction-changed" false (unit --> return_void) f
      val grab_notify_sig : (bool -> unit) -> 'a t Signal.signal
	  = fn f => signal "grab-notify" false (bool --> return_void) f
      val child_notify_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "child-notify" false (unit --> return_void) f
      val mnemonic_activate_sig : (bool -> bool) -> 'a t Signal.signal
	  = fn f => signal "mnemonic-activate" false (bool --> return_bool) f
      val grab_focus_sig : (unit -> unit) -> 'a t Signal.signal
      ...
      val button_press_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "button-press-event" false (unit --> return_bool) f
      val button_release_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f =>
	       signal "button-release-event" false (unit --> return_bool) f
      val scroll_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "scroll-event" false (unit --> return_bool) f
      val motion_notify_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "motion-notify-event" false (unit --> return_bool) f
      val delete_event_sig : (unit -> bool) -> 'a t Signal.signal
      ...
      val key_release_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "key-release-event" false (unit --> return_bool) f
      val enter_notify_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "enter-notify-event" false (unit --> return_bool) f
      val leave_notify_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "leave-notify-event" false (unit --> return_bool) f
      val configure_event_sig : (unit -> bool) -> 'a t Signal.signal
      ...
      val property_notify_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f =>
	       signal "property-notify-event" false (unit --> return_bool) f
      val selection_clear_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f =>
	       signal "selection-clear-event" false (unit --> return_bool) f
      val selection_request_event_sig : (unit -> bool) -> 'a t Signal.signal
      ...
      val proximity_in_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "proximity-in-event" false (unit --> return_bool) f
      val proximity_out_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "proximity-out-event" false (unit --> return_bool) f
      val drag_leave_sig : (unit -> int -> unit) -> 'a t Signal.signal
	  = fn f => signal "drag-leave" false (unit --> int --> return_void) f
      val drag_begin_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "drag-begin" false (unit --> return_void) f
      val drag_end_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "drag-end" false (unit --> return_void) f
      val drag_data_delete_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "drag-data-delete" false (unit --> return_void) f
      val drag_motion_sig : (unit -> int -> int -> int -> bool)
			    -> 'a t Signal.signal
      ...
      val drag_data_get_sig : (unit -> unit -> int -> int -> unit)
			      -> 'a t Signal.signal
	  = fn f => signal "drag-data-get" false
			   (unit --> unit --> int --> int --> return_void) f
      val drag_data_received_sig
	: (unit -> int -> int -> unit -> int -> int -> unit)
	  -> 'a t Signal.signal
	  = fn f => signal 
(*  27*)"drag-data-received" false
(*  27*) (unit --> int --> int --> unit --> int --> int --> return_void) f
      val visibility_notify_event_sig : (unit -> bool) -> 'a t Signal.signal
      ...
      val window_state_event_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "window-state-event" false (unit --> return_bool) f
      val popup_menu_sig : (unit -> bool) -> 'a t Signal.signal
...
structure Editable :> Editable = struct
    ...
    fun toEditable obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_editable_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn start_pos => fn end_pos =>
	     GObject.withPtr
	       (self, 
		fn self => let val t = get_chars_ (self, start_pos, end_pos)
			   in CString.toString t end)
...
structure ItemFactory :> ItemFactory = struct
	...
	= _import "gtk_item_factory_get_widget_by_action" : cptr * int -> cptr;
    val get_widget_by_action : 'a t -> int -> base Widget.t
	= fn self => fn action =>
	     Widget.inherit ()
			    (fn () => GObject.withPtr
	...
	= _import "gtk_item_factory_get_item_by_action" : cptr * int -> cptr;
    val get_item_by_action : 'a t -> int -> base Widget.t
	= fn self => fn action =>
	     Widget.inherit ()
			    (fn () => GObject.withPtr
	...
	= fn self => fn path =>
	     GObject.withPtr
	       (self, fn self => delete_item_ (self, CString.fromString path))
end
signature IMContext = sig
    type base
    type 'a imcontext_t
    ...
    val simple_get_type : unit -> int
end
structure IMContext :> IMContext = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toIMContext obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_im_context_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val reset_ : cptr -> unit = _import "gtk_im_context_reset" : cptr -> unit;
    val reset : 'a t -> unit
	...
	= fn self => fn offset => fn n_chars =>
	     GObject.withPtr
	       (self, fn self => delete_surrounding_ (self, offset, n_chars))
    val simple_get_type_ : unit -> int
	= _import "gtk_im_context_simple_get_type" : unit -> int;
    val simple_get_type : unit -> int = fn dummy => simple_get_type_ dummy
end
signature IMContextSimple = sig
    type base
...
structure IMContextSimple :> IMContextSimple = struct
    type cptr = GObject.cptr
    type base = unit
...
structure IMMulticontext :> IMMulticontext = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toIMMulticontext obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_im_multicontext_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_im_multicontext_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val append_menuitems_ : cptr * cptr -> unit
	= _import "gtk_im_multicontext_append_menuitems" : cptr * cptr -> unit;
    val append_menuitems : 'a t -> 'b t -> unit
...
signature CellRenderer = sig
    ...
    val pixbuf_get_type : unit -> int
    val text_get_type : unit -> int
    val toggle_get_type : unit -> int
end
structure CellRenderer :> CellRenderer = struct
	...
	= let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
	  in get_state_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
    type mode = int
	...
	= let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
	  in get_mode_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
    val get_type_ : unit -> int
    ...
    val pixbuf_get_type_ : unit -> int
	= _import "gtk_cell_renderer_pixbuf_get_type" : unit -> int;
    val pixbuf_get_type : unit -> int = fn dummy => pixbuf_get_type_ dummy
    val text_get_type_ : unit -> int
	= _import "gtk_cell_renderer_text_get_type" : unit -> int;
    val text_get_type : unit -> int = fn dummy => text_get_type_ dummy
    val toggle_get_type_ : unit -> int
	= _import "gtk_cell_renderer_toggle_get_type" : unit -> int;
    val toggle_get_type : unit -> int = fn dummy => toggle_get_type_ dummy
end
...
structure CellEditable :> CellEditable = struct
    ...
    fun toCellEditable obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_cell_editable_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
signature CellRendererToggle = sig
    type base
...
structure CellRendererToggle :> CellRendererToggle = struct
    type cptr = GObject.cptr
    type base = unit
	...
	= _import "gtk_cell_renderer_toggle_set_radio" : cptr * bool -> unit;
    val set_radio : 'a t -> bool -> unit
	= fn self => fn radio =>
	...
	= _import "gtk_cell_renderer_toggle_set_active" : cptr * bool -> unit;
    val set_active : 'a t -> bool -> unit
	= fn self => fn setting =>
...
signature CellRendererText = sig
    type base
...
structure CellRendererText :> CellRendererText = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    in val edited_sig : (char -> char -> unit) -> 'a t Signal.signal
	   = fn f => signal "edited" false (char --> char --> return_void) f
    end
end
signature CellRendererPixbuf = sig
    type base
...
structure CellRendererPixbuf :> CellRendererPixbuf = struct
    type cptr = GObject.cptr
    type base = unit
...
signature RcStyle = sig
    ...
    val rc_get_style_by_paths : 'a t -> string -> string -> int -> base t
    ...
    val rc_style_get_type : unit -> int
...
structure RcStyle :> RcStyle = struct
    ...
    val rc_get_style_by_paths_
      : cptr * CString.cstring * CString.cstring * int -> cptr
	...
	= _import "gtk_rc_add_class_style" : cptr * CString.cstring -> unit;
    val rc_add_class_style : 'a t -> string -> unit
	= fn self => fn pattern =>
	     GObject.withPtr (self, 
			      fn self => rc_add_class_style_
					   (self, CString.fromString pattern))
    val rc_style_get_type_ : unit -> int
	= _import "gtk_rc_style_get_type" : unit -> int;
    val rc_style_get_type : unit -> int = fn dummy => rc_style_get_type_ dummy
    ...
    val rc_style_unref : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => rc_style_unref_ self)
    val rc_find_module_in_path_ : CString.cstring -> CString.t
	= _import "gtk_rc_find_module_in_path" : CString.cstring -> CString.t;
    val rc_find_module_in_path : string -> string
...
structure Settings :> Settings = struct
    ...
    fun toSettings obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_settings_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val get_default_ : unit -> cptr
	= _import "gtk_settings_get_default" : unit -> cptr;
    val get_default : unit -> base t = fn dummy => make (get_default_ dummy)
	...
	= _import "gtk_settings_set_string_property"
		  : cptr * CString.cstring * CString.cstring * CString.cstring
		    -> unit;
    val set_string_property : 'a t -> string -> string -> string -> unit
...
structure SizeGroup :> SizeGroup = struct
    type cptr = GObject.cptr
    type base = unit
	...
	= let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
	  in get_mode_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
    val get_type_ : unit -> int
	= _import "gtk_size_group_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Style :> Style = struct
    ...
    fun toStyle obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_style_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= _import "gtk_style_lookup_icon_set" : cptr * CString.cstring -> cptr;
    val lookup_icon_set : 'a t -> string -> icon_set
	= fn self => fn stock_id =>
	     GObject.withPtr (self, 
...
signature TextBuffer = sig
    ...
    val insert_interactive : 'a t -> textiter -> string -> int -> bool -> bool
    val insert_interactive_at_cursor : 'a t -> string -> int -> bool -> bool
    val insert_range : 'a t -> textiter -> textiter -> textiter -> unit
    val insert_range_interactive
      : 'a t -> textiter -> textiter -> textiter -> bool -> bool
    val insert_with_tags : 'a t -> textiter -> string -> int -> 'b t -> unit
    ...
    val getiter_at_line_offset : 'a t -> textiter -> int -> int -> unit
    val getiter_at_line_index : 'a t -> textiter -> int -> int -> unit
    val getiter_at_offset : 'a t -> textiter -> int -> unit
    val getiter_at_line : 'a t -> textiter -> int -> unit
    val get_startiter : 'a t -> textiter -> unit
    val get_enditer : 'a t -> textiter -> unit
    val get_bounds : 'a t -> textiter -> textiter -> unit
    val getiter_at_mark : 'a t -> textiter -> 'b t -> unit
    val getiter_at_child_anchor : 'a t -> textiter -> 'b t -> unit
    ...
    val get_selection_bounds : 'a t -> textiter -> textiter -> bool
    val delete_selection : 'a t -> bool -> bool -> bool
    val begin_user_action : 'a t -> unit
    val end_user_action : 'a t -> unit
    val changed_sig : (unit -> unit) -> 'a t Signal.signal
    val insert_text_sig : (unit -> char -> int -> unit) -> 'a t Signal.signal
    val insert_pixbuf_sig : (unit -> unit -> unit) -> 'a t Signal.signal
    val insert_child_anchor_sig : (unit -> unit -> unit) -> 'a t Signal.signal
    ...
    val apply_tag_sig : (unit -> unit -> unit -> unit) -> 'a t Signal.signal
    val remove_tag_sig : (unit -> unit -> unit -> unit) -> 'a t Signal.signal
...
structure TextBuffer :> TextBuffer = struct
    ...
    fun toTextBuffer obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_text_buffer_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : cptr -> cptr = _import "gtk_text_buffer_new" : cptr -> cptr;
    val new : 'a t option -> base t
	= fn table => make (GObject.withOpt (table, fn table => new_ table))
    ...
    val get_line_count : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_line_count_ self)
    val get_char_count_ : cptr -> int
	= _import "gtk_text_buffer_get_char_count" : cptr -> int;
    val get_char_count : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_char_count_ self)
	...
	= fn self => fn iter => fn text =>
	     GObject.withPtr
	       (self, 
		fn self => insert_ (self, iter, CString.fromString text, ~1))
    ...
    val insert_range_interactive_ : cptr * cptr * cptr * cptr * bool -> bool
	...
	= fn self => fn iter => fn start => fn en => fn default_editable =>
	     GObject.withPtr (self, 
			      fn self => insert_range_interactive_
					   (self, iter, start, en, 
					    default_editable))
    val insert_with_tags_ : cptr * cptr * CString.cstring * int * cptr -> unit
	...
	= fn self => fn iter => fn text => fn len => fn first_tag =>
	     GObject.withPtr
	       (self, 
		fn self => GObject.withPtr (first_tag, 
					    fn first_tag =>
					       insert_with_tags_
						 (self, iter, 
	...
	= fn self => fn start => fn en => fn include_hidden_chars =>
	     GObject.withPtr
	       (self, 
		fn self =>
		   let val t = get_text_ (self, start, en, 
	...
	= _import "gtk_text_buffer_create_child_anchor" : cptr * cptr -> cptr;
    val create_child_anchor : 'a t -> textiter -> base t
	= fn self => fn iter =>
	     make (GObject.withPtr
	...
	= fn self => fn mark_name => fn wher => fn left_gravity =>
	     make (GObject.withPtr
		     (self, 
		      fn self =>
			 create_mark_
			   (self, CString.fromString (getOpt (mark_name, "")), 
	     ...
	     make (GObject.withPtr
		     (self, 
		      fn self => create_mark_
				   (self, CString.fromString "", wher, false)))
	...
	= _import "gtk_text_buffer_get_mark" : cptr * CString.cstring -> cptr;
    val get_mark : 'a t -> string -> base t
	= fn self => fn name =>
	     make (GObject.withPtr
		     (self, 
		      fn self => get_mark_ (self, CString.fromString name)))
    ...
    val get_insert : 'a t -> base t
	= fn self => make (GObject.withPtr (self, fn self => get_insert_ self))
	...
	= _import "gtk_text_buffer_get_iter_at_offset"
		  : cptr * cptr * int -> unit;
    val getiter_at_offset : 'a t -> textiter -> int -> unit
	= fn self => fn iter => fn char_offset =>
	     GObject.withPtr
	       (self, fn self => getiter_at_offset_ (self, iter, char_offset))
    val getiter_at_line_ : cptr * cptr * int -> unit
	= _import "gtk_text_buffer_get_iter_at_line"
		  : cptr * cptr * int -> unit;
    val getiter_at_line : 'a t -> textiter -> int -> unit
	= fn self => fn iter => fn line_number =>
	     GObject.withPtr
	       (self, fn self => getiter_at_line_ (self, iter, line_number))
    val get_startiter_ : cptr * cptr -> unit
	= _import "gtk_text_buffer_get_start_iter" : cptr * cptr -> unit;
    val get_startiter : 'a t -> textiter -> unit
	= fn self => fn iter =>
	     GObject.withPtr (self, fn self => get_startiter_ (self, iter))
    val get_enditer_ : cptr * cptr -> unit
	= _import "gtk_text_buffer_get_end_iter" : cptr * cptr -> unit;
    val get_enditer : 'a t -> textiter -> unit
	= fn self => fn iter =>
	     GObject.withPtr (self, fn self => get_enditer_ (self, iter))
    val get_bounds_ : cptr * cptr * cptr -> unit
	= _import "gtk_text_buffer_get_bounds" : cptr * cptr * cptr -> unit;
    val get_bounds : 'a t -> textiter -> textiter -> unit
	= fn self => fn start => fn en =>
	     GObject.withPtr (self, fn self => get_bounds_ (self, start, en))
    val getiter_at_mark_ : cptr * cptr * cptr -> unit
	= _import "gtk_text_buffer_get_iter_at_mark"
		  : cptr * cptr * cptr -> unit;
    val getiter_at_mark : 'a t -> textiter -> 'b t -> unit
	= fn self => fn iter => fn mark =>
	     GObject.withPtr
	       (self, 
		fn self =>
		   GObject.withPtr
		     (mark, fn mark => getiter_at_mark_ (self, iter, mark)))
	...
	= fn self => fn iter => fn anchor =>
		...
		fn self => GObject.withPtr
			     (anchor, 
			      fn anchor => getiter_at_child_anchor_
					     (self, iter, anchor)))
    ...
    val set_modified : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr (self, fn self => set_modified_ (self, setting))
	...
	= _import "gtk_text_buffer_cut_clipboard" : cptr * cptr * bool -> unit;
    val cut_clipboard : 'a t -> 'b t -> bool -> unit
	...
	= fn self => fn start => fn en =>
	     GObject.withPtr
	       (self, fn self => get_selection_bounds_ (self, start, en))
	...
	: (unit -> unit -> unit) -> 'a t Signal.signal
      ...
      val delete_range_sig : (unit -> unit -> unit) -> 'a t Signal.signal
	  = fn f =>
	       signal "delete-range" false (unit --> unit --> return_void) f
      val modified_changed_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "modified-changed" false (void --> return_void) f
      val mark_set_sig : (unit -> unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "mark-set" false (unit --> unit --> return_void) f
      val mark_deleted_sig : (unit -> unit) -> 'a t Signal.signal
	  ...
	  = fn f => signal "remove-tag" false
			   (unit --> unit --> unit --> return_void) f
      val begin_user_action_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "begin-user-action" false (void --> return_void) f
      val end_user_action_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "end-user-action" false (void --> return_void) f
    end
end
signature TextChildAnchor = sig
    type base
...
structure TextChildAnchor :> TextChildAnchor = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTextChildAnchor obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_text_child_anchor_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr
...
structure TextMark :> TextMark = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTextMark obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_text_mark_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val set_visible_ : cptr * bool -> unit
	= _import "gtk_text_mark_set_visible" : cptr * bool -> unit;
    val set_visible : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr (self, fn self => set_visible_ (self, setting))
    ...
    val get_left_gravity : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_left_gravity_ self)
end
signature TextTag = sig
    type base
    type 'a texttag_t
    ...
    val table_get_type : unit -> int
    val event_sig : (unit -> unit -> unit -> bool) -> 'a t Signal.signal
end
structure TextTag :> TextTag = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTextTag obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_text_tag_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val new' : unit -> base t = fn dummy => make (new_ (CString.fromString ""))
    ...
    val set_priority : 'a t -> int -> unit
	= fn self => fn priority =>
	     GObject.withPtr (self, fn self => set_priority_ (self, priority))
    val table_get_type_ : unit -> int
	= _import "gtk_text_tag_table_get_type" : unit -> int;
    val table_get_type : unit -> int = fn dummy => table_get_type_ dummy
    local open Signal
	  infixr -->
...
structure TextTagTable :> TextTagTable = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTextTagTable obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val new_ : unit -> cptr = _import "gtk_text_tag_table_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
	...
	= fn self => fn tag =>
	     GObject.withPtr
	       (self, 
		fn self => GObject.withPtr (tag, fn tag => add_ (self, tag)))
    ...
    val lookup_ : cptr * CString.cstring -> cptr
	= _import "gtk_text_tag_table_lookup" : cptr * CString.cstring -> cptr;
    val lookup : 'a t -> string -> base t
	= fn self => fn name =>
	     make (GObject.withPtr
		     (self, 
    ...
    in val tag_changed_sig : (unit -> bool -> unit) -> 'a t Signal.signal
	   = fn f =>
		signal "tag-changed" false (unit --> bool --> return_void) f
       val tag_added_sig : (unit -> unit) -> 'a t Signal.signal
...
structure Tooltips :> Tooltips = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTooltips obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_tooltips_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_tooltips_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val enable_ : cptr -> unit = _import "gtk_tooltips_enable" : cptr -> unit;
    val enable : 'a t -> unit
...
signature TreeModel = sig
    ...
    val get_columntype : 'a t -> int -> int
    val getiter : 'a t -> treeiter -> tree_path -> bool
    ...
    val iter_nth_child : 'a t -> treeiter -> treeiter option -> int -> bool
    val iter_nth_child' : 'a t -> treeiter -> int -> bool
...
structure TreeModel :> TreeModel = struct
	...
	= _import "mgtk_get_gtk_treemodel_flags" : int ref * int ref -> unit;
    val (TREE_MODEL_ITERS_PERSIST, TREE_MODEL_LIST_ONLY)
	= let val (x0, x1) = (ref 0, ref 0)
	  in get_flags_ (x0, x1); (! x0, ! x1)  end
    val get_type_ : unit -> int
	= _import "gtk_tree_model_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_columntype_ : cptr * int -> int
	= _import "gtk_tree_model_get_column_type" : cptr * int -> int;
    val get_columntype : 'a t -> int -> int
	= fn self => fn index =>
	     GObject.withPtr (self, fn self => get_columntype_ (self, index))
    val getiter_ : cptr * cptr * cptr -> bool
	= _import "gtk_tree_model_get_iter" : cptr * cptr * cptr -> bool;
    val getiter : 'a t -> treeiter -> tree_path -> bool
	= fn self => fn iter => fn path =>
	     GObject.withPtr (self, fn self => getiter_ (self, iter, path))
    ...
    val iter_has_child : 'a t -> treeiter -> bool
	= fn self => fn iter =>
	     GObject.withPtr (self, fn self => iter_has_child_ (self, iter))
    ...
    val iter_nth_child : 'a t -> treeiter -> treeiter option -> int -> bool
	= fn self => fn iter => fn parent => fn n =>
	     GObject.withPtr
	       (self, 
		fn self => iter_nth_child_
			     (self, iter, getOpt (parent, GObject.null), n))
    val iter_nth_child' : 'a t -> treeiter -> int -> bool
	= fn self => fn iter => fn n =>
	     GObject.withPtr
	       (self, fn self => iter_nth_child_ (self, iter, GObject.null, n))
	...
	= _import "gtk_tree_model_row_changed" : cptr * cptr * cptr -> unit;
    val row_changed : 'a t -> tree_path -> treeiter -> unit
	= fn self => fn path => fn iter =>
	     GObject.withPtr (self, fn self => row_changed_ (self, path, iter))
    val row_inserted_ : cptr * cptr * cptr -> unit
	= _import "gtk_tree_model_row_inserted" : cptr * cptr * cptr -> unit;
    val row_inserted : 'a t -> tree_path -> treeiter -> unit
	= fn self => fn path => fn iter =>
	     GObject.withPtr
    ...
    val sort_get_type_ : unit -> int
	= _import "gtk_tree_model_sort_get_type" : unit -> int;
    val sort_get_type : unit -> int = fn dummy => sort_get_type_ dummy
end
signature TreeDragSource = sig
    type base
...
structure TreeDragSource :> TreeDragSource = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTreeDragSource obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_tree_drag_source_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val row_draggable_ : cptr * cptr -> bool
	= _import "gtk_tree_drag_source_row_draggable" : cptr * cptr -> bool;
    val row_draggable : 'a t -> tree_path -> bool
	= fn self => fn path =>
    ...
    val drag_data_delete : 'a t -> tree_path -> bool
	= fn self => fn path =>
	     GObject.withPtr (self, fn self => drag_data_delete_ (self, path))
	...
	= fn self => fn path => fn selection_data =>
	     GObject.withPtr
	       (self, fn self => drag_data_get_ (self, path, selection_data))
end
signature TreeDragDest = sig
    type base
...
structure TreeDragDest :> TreeDragDest = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTreeDragDest obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_tree_drag_dest_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn dest_path => fn selection_data =>
	     GObject.withPtr (self, 
			      fn self => row_drop_possible_
					   (self, dest_path, selection_data))
end
signature TreeSortable = sig
    type base
...
structure TreeSortable :> TreeSortable = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTreeSortable obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_tree_sortable_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
signature ListStore = sig
    ...
    val remove : 'a t -> treeiter -> unit
    val insert : 'a t -> treeiter -> int -> unit
    val insert_before : 'a t -> treeiter -> treeiter -> unit
    val insert_after : 'a t -> treeiter -> treeiter -> unit
    val prepend : 'a t -> treeiter -> unit
    val append : 'a t -> treeiter -> unit
    val clear : 'a t -> unit
end
structure ListStore :> ListStore = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    val remove : 'a t -> treeiter -> unit
	= fn self => fn iter =>
	     GObject.withPtr (self, fn self => remove_ (self, iter))
    val insert_ : cptr * cptr * int -> unit
	= _import "gtk_list_store_insert" : cptr * cptr * int -> unit;
    val insert : 'a t -> treeiter -> int -> unit
	= fn self => fn iter => fn position =>
	     GObject.withPtr (self, fn self => insert_ (self, iter, position))
    val insert_before_ : cptr * cptr * cptr -> unit
	= _import "gtk_list_store_insert_before" : cptr * cptr * cptr -> unit;
    val insert_before : 'a t -> treeiter -> treeiter -> unit
	= fn self => fn iter => fn sibling =>
	     GObject.withPtr
	       (self, fn self => insert_before_ (self, iter, sibling))
    val insert_after_ : cptr * cptr * cptr -> unit
	= _import "gtk_list_store_insert_after" : cptr * cptr * cptr -> unit;
    val insert_after : 'a t -> treeiter -> treeiter -> unit
	= fn self => fn iter => fn sibling =>
	     GObject.withPtr
	       (self, fn self => insert_after_ (self, iter, sibling))
    val prepend_ : cptr * cptr -> unit
	= _import "gtk_list_store_prepend" : cptr * cptr -> unit;
    val prepend : 'a t -> treeiter -> unit
	= fn self => fn iter =>
	     GObject.withPtr (self, fn self => prepend_ (self, iter))
    val append_ : cptr * cptr -> unit
	= _import "gtk_list_store_append" : cptr * cptr -> unit;
    val append : 'a t -> treeiter -> unit
	= fn self => fn iter =>
	     GObject.withPtr (self, fn self => append_ (self, iter))
    val clear_ : cptr -> unit = _import "gtk_list_store_clear" : cptr -> unit;
    val clear : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => clear_ self)
end
signature TreeModelSort = sig
    type base
    ...
    val convert_childiter_toiter : 'a t -> treeiter option -> treeiter -> unit
    val convert_childiter_toiter' : 'a t -> treeiter -> unit
    val convert_path_to_child_path : 'a t -> tree_path -> tree_path
    val convertiter_to_childiter : 'a t -> treeiter option -> treeiter -> unit
    val convertiter_to_childiter' : 'a t -> treeiter -> unit
    val reset_default_sort_func : 'a t -> unit
    val clear_cache : 'a t -> unit
end
structure TreeModelSort :> TreeModelSort = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    val get_model : 'a t -> base t
	= fn self => make (GObject.withPtr (self, fn self => get_model_ self))
	...
	= _import "gtk_tree_model_sort_convert_child_iter_to_iter"
		  : cptr * cptr * cptr -> unit;
    val convert_childiter_toiter : 'a t -> treeiter option -> treeiter -> unit
	= fn self => fn sort_iter => fn child_iter =>
	     GObject.withPtr
	       (self, 
		fn self => convert_childiter_toiter_
			     (self, getOpt (sort_iter, GObject.null), 
			      child_iter))
    val convert_childiter_toiter' : 'a t -> treeiter -> unit
	= fn self => fn child_iter =>
	     GObject.withPtr (self, 
			      fn self => convert_childiter_toiter_
					   (self, GObject.null, child_iter))
	...
	= _import "gtk_tree_model_sort_convert_iter_to_child_iter"
		  : cptr * cptr * cptr -> unit;
    val convertiter_to_childiter : 'a t -> treeiter option -> treeiter -> unit
	= fn self => fn child_iter => fn sorted_iter =>
	     GObject.withPtr
	       (self, 
		fn self => convertiter_to_childiter_
			     (self, getOpt (child_iter, GObject.null), 
			      sorted_iter))
    val convertiter_to_childiter' : 'a t -> treeiter -> unit
	= fn self => fn sorted_iter =>
	     GObject.withPtr (self, 
			      fn self => convertiter_to_childiter_
					   (self, GObject.null, sorted_iter))
    val reset_default_sort_func_ : cptr -> unit
	= _import "gtk_tree_model_sort_reset_default_sort_func" : cptr -> unit;
    val reset_default_sort_func : 'a t -> unit
	= fn self => GObject.withPtr
...
signature TreeSelection = sig
    ...
    val get_selected : 'a t -> 'b TreeModel.t -> treeiter -> bool
...
structure TreeSelection :> TreeSelection = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTreeSelection obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_tree_selection_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val set_mode_ : cptr * int -> unit
    ...
    val get_selected_ : cptr * cptr * cptr -> bool
	= _import "gtk_tree_selection_get_selected"
		  : cptr * cptr * cptr -> bool;
    val get_selected : 'a t -> 'b TreeModel.t -> treeiter -> bool
	= fn self => fn model => fn iter =>
	     GObject.withPtr
	       (self, 
		fn self =>
		   GObject.withPtr
		     (model, fn model => get_selected_ (self, model, iter)))
	...
	= _import "gtk_tree_selection_path_is_selected" : cptr * cptr -> bool;
    val path_is_selected : 'a t -> tree_path -> bool
	= fn self => fn path =>
	     GObject.withPtr (self, fn self => path_is_selected_ (self, path))
    val iter_is_selected_ : cptr * cptr -> bool
	= _import "gtk_tree_selection_iter_is_selected" : cptr * cptr -> bool;
    val iter_is_selected : 'a t -> treeiter -> bool
	= fn self => fn iter =>
	     GObject.withPtr (self, fn self => iter_is_selected_ (self, iter))
	...
	= fn self => fn start_path => fn end_path =>
	     GObject.withPtr
	       (self, fn self => select_range_ (self, start_path, end_path))
    local open Signal
	  infixr -->
    in val changed_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "changed" false (void --> return_void) f
...
signature TreeStore = sig
    ...
    val set : 'a t -> treeiter -> unit
    val remove : 'a t -> treeiter -> unit
    val insert : 'a t -> treeiter -> treeiter -> int -> unit
    val insert_before : 'a t -> treeiter -> treeiter -> treeiter -> unit
    val insert_after : 'a t -> treeiter -> treeiter -> treeiter -> unit
    val prepend : 'a t -> treeiter -> treeiter -> unit
    val append : 'a t -> treeiter -> treeiter -> unit
    val is_ancestor : 'a t -> treeiter -> treeiter -> bool
    val storeiter_depth : 'a t -> treeiter -> int
    val clear : 'a t -> unit
end
structure TreeStore :> TreeStore = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTreeStore obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_tree_store_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= _import "gtk_tree_store_insert" : cptr * cptr * cptr * int -> unit;
    val insert : 'a t -> treeiter -> treeiter -> int -> unit
	= fn self => fn iter => fn parent => fn position =>
	     GObject.withPtr
	       (self, fn self => insert_ (self, iter, parent, position))
    val insert_before_ : cptr * cptr * cptr * cptr -> unit
	= _import "gtk_tree_store_insert_before"
		  : cptr * cptr * cptr * cptr -> unit;
    val insert_before : 'a t -> treeiter -> treeiter -> treeiter -> unit
	= fn self => fn iter => fn parent => fn sibling =>
	     GObject.withPtr
	       (self, fn self => insert_before_ (self, iter, parent, sibling))
	...
	= fn self => fn iter => fn parent => fn sibling =>
	     GObject.withPtr
	       (self, fn self => insert_after_ (self, iter, parent, sibling))
    val prepend_ : cptr * cptr * cptr -> unit
	= _import "gtk_tree_store_prepend" : cptr * cptr * cptr -> unit;
    val prepend : 'a t -> treeiter -> treeiter -> unit
	= fn self => fn iter => fn parent =>
	     GObject.withPtr (self, fn self => prepend_ (self, iter, parent))
    val append_ : cptr * cptr * cptr -> unit
	= _import "gtk_tree_store_append" : cptr * cptr * cptr -> unit;
    val append : 'a t -> treeiter -> treeiter -> unit
	= fn self => fn iter => fn parent =>
	     GObject.withPtr (self, fn self => append_ (self, iter, parent))
    val is_ancestor_ : cptr * cptr * cptr -> bool
	= _import "gtk_tree_store_is_ancestor" : cptr * cptr * cptr -> bool;
    val is_ancestor : 'a t -> treeiter -> treeiter -> bool
    ...
    val storeiter_depth : 'a t -> treeiter -> int
	= fn self => fn iter =>
	     GObject.withPtr (self, fn self => storeiter_depth_ (self, iter))
    val clear_ : cptr -> unit = _import "gtk_tree_store_clear" : cptr -> unit;
    val clear : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => clear_ self)
end
signature TreeViewColumn = sig
    type base
...
structure TreeViewColumn :> TreeViewColumn = struct
    type cptr = GObject.cptr
    type base = unit
	...
	= let val (x0, x1, x2) = (ref 0, ref 0, ref 0)
	  in get_sizing_ (x0, x1, x2); (! x0, ! x1, ! x2)  end
    val get_type_ : unit -> int
	= _import "gtk_tree_view_column_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr
	...
	= _import "gtk_tree_view_column_pack_end" : cptr * cptr * bool -> unit;
    val pack_end : 'a t -> 'b CellRenderer.t -> bool -> unit
	= fn self => fn cell => fn expand =>
	     GObject.withPtr
	       (self, 
	...
	= fn self => fn cell_renderer => fn attribute => fn column =>
		...
		fn self => GObject.withPtr
			     (cell_renderer, 
			      fn cell_renderer =>
				 add_attribute_ (self, cell_renderer, 
						 CString.fromString attribute, 
						 column)))
    val set_attributes_ : cptr * cptr -> unit
	= _import "gtk_tree_view_column_set_attributes" : cptr * cptr -> unit;
    val set_attributes : 'a t -> 'b CellRenderer.t -> unit
    ...
    val set_spacing : 'a t -> int -> unit
	= fn self => fn spacing =>
	     GObject.withPtr (self, fn self => set_spacing_ (self, spacing))
    ...
    val set_visible : 'a t -> bool -> unit
	= fn self => fn visible =>
	     GObject.withPtr (self, fn self => set_visible_ (self, visible))
    val get_visible_ : cptr -> bool
	= _import "gtk_tree_view_column_get_visible" : cptr -> bool;
    val get_visible : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_visible_ self)
    val set_resizable_ : cptr * bool -> unit
	= _import "gtk_tree_view_column_set_resizable" : cptr * bool -> unit;
    val set_resizable : 'a t -> bool -> unit
    ...
    val get_fixed_width : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_fixed_width_ self)
    val set_fixed_width_ : cptr * int -> unit
	= _import "gtk_tree_view_column_set_fixed_width" : cptr * int -> unit;
    val set_fixed_width : 'a t -> int -> unit
	= fn self => fn fixed_width =>
	     GObject.withPtr
	       (self, fn self => set_fixed_width_ (self, fixed_width))
    val set_min_width_ : cptr * int -> unit
	= _import "gtk_tree_view_column_set_min_width" : cptr * int -> unit;
    val set_min_width : 'a t -> int -> unit
	...
	= _import "gtk_tree_view_column_set_max_width" : cptr * int -> unit;
    val set_max_width : 'a t -> int -> unit
	...
	= fn self => fn title =>
	     GObject.withPtr
	       (self, fn self => set_title_ (self, CString.fromString title))
	...
	= _import "gtk_tree_view_column_set_clickable" : cptr * bool -> unit;
    val set_clickable : 'a t -> bool -> unit
	= fn self => fn active =>
	     GObject.withPtr (self, fn self => set_clickable_ (self, active))
	...
	= _import "gtk_tree_view_column_set_alignment" : cptr * real -> unit;
    val set_alignment : 'a t -> real -> unit
	= fn self => fn xalign =>
	     GObject.withPtr (self, fn self => set_alignment_ (self, xalign))
	...
	= _import "gtk_tree_view_column_set_reorderable" : cptr * bool -> unit;
    val set_reorderable : 'a t -> bool -> unit
    ...
    val get_reorderable : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_reorderable_ self)
	...
	= fn self => fn sort_column_id =>
	     GObject.withPtr
	       (self, fn self => set_sort_column_id_ (self, sort_column_id))
	...
	= _import "gtk_tree_view_column_set_sort_order" : cptr * int -> unit;
    val set_sort_order : 'a t -> sorttype -> unit
	= fn self => fn order =>
	     GObject.withPtr (self, fn self => set_sort_order_ (self, order))
    val get_sort_order_ : cptr -> int
	= _import "gtk_tree_view_column_get_sort_order" : cptr -> int;
    val get_sort_order : 'a t -> sorttype
	= fn self => GObject.withPtr (self, fn self => get_sort_order_ self)
    ...
    val cell_is_visible : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => cell_is_visible_ self)
    local open Signal
	  infixr -->
...
signature Separator = sig
    ...
    val get_type : unit -> int
    val menu_item_get_type : unit -> int
end
structure Separator :> Separator = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toSeparator obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_separator_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val menu_item_get_type_ : unit -> int
	= _import "gtk_separator_menu_item_get_type" : unit -> int;
    val menu_item_get_type : unit -> int
	= fn dummy => menu_item_get_type_ dummy
end
signature VSeparator = sig
    type base
    type 'a vseparator_t
...
structure VSeparator :> VSeparator = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toVSeparator obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_vseparator_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_vseparator_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
end
signature HSeparator = sig
    type base
    type 'a hseparator_t
...
structure HSeparator :> HSeparator = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toHSeparator obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_hseparator_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Ruler :> Ruler = struct
    ...
    fun toRuler obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_ruler_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val draw_pos_ : cptr -> unit = _import "gtk_ruler_draw_pos" : cptr -> unit;
    val draw_pos : 'a t -> unit
...
structure VRuler :> VRuler = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toVRuler obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_vruler_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_vruler_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
end
signature HRuler = sig
    type base
    type 'a hruler_t
...
structure HRuler :> HRuler = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toHRuler obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_hruler_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Range :> Range = struct
    ...
    fun toRange obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_range_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_update_policy : 'a t -> updatetype
	= fn self => GObject.withPtr (self, fn self => get_update_policy_ self)
    ...
    val set_inverted : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr (self, fn self => set_inverted_ (self, setting))
...
structure Scrollbar :> Scrollbar = struct
    ...
    fun toScrollbar obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_scrollbar_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
end
signature VScrollbar = sig
    type base
    type 'a vscrollbar_t
...
structure VScrollbar :> VScrollbar = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toVScrollbar obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_vscrollbar_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure HScrollbar :> HScrollbar = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toHScrollbar obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_hscrollbar_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Scale :> Scale = struct
    ...
    fun toScale obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_scale_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_draw_value : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_draw_value_ self)
...
structure VScale :> VScale = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toVScale obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_vscale_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure HScale :> HScale = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toHScale obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_hscale_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Progress :> Progress = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toProgress obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_progress_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn x_align => fn y_align =>
	     GObject.withPtr
	       (self, fn self => set_text_alignment_ (self, x_align, y_align))
	...
	= _import "gtk_progress_configure" : cptr * real * real * real -> unit;
    val configure : 'a t -> real -> real -> real -> unit
...
structure ProgressBar :> ProgressBar = struct
    type cptr = GObject.cptr
    type base = unit
	...
	= _import "mgtk_get_gtk_progressbar_style" : int ref * int ref -> unit;
    val (PROGRESS_CONTINUOUS, PROGRESS_DISCRETE)
	= let val (x0, x1) = (ref 0, ref 0)
	  in get_style_ (x0, x1); (! x0, ! x1)  end
    type orientation = int
	...
	= let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
	  in get_orientation_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
    val get_type_ : unit -> int
	= _import "gtk_progress_bar_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_progress_bar_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
	...
	= _import "gtk_progress_bar_set_text" : cptr * CString.cstring -> unit;
    val set_text : 'a t -> string -> unit
	= fn self => fn text =>
	     GObject.withPtr
    ...
    val set_fraction : 'a t -> real -> unit
	= fn self => fn fraction =>
	     GObject.withPtr (self, fn self => set_fraction_ (self, fraction))
    ...
    val get_pulse_step : 'a t -> real
	= fn self => GObject.withPtr (self, fn self => get_pulse_step_ self)
    val get_orientation_ : cptr -> int
	= _import "gtk_progress_bar_get_orientation" : cptr -> int;
    val get_orientation : 'a t -> orientation
	= fn self => GObject.withPtr (self, fn self => get_orientation_ self)
    ...
    val set_bar_style : 'a t -> style -> unit
	= fn self => fn style =>
	     GObject.withPtr (self, fn self => set_bar_style_ (self, style))
    val set_discrete_blocks_ : cptr * int -> unit
	= _import "gtk_progress_bar_set_discrete_blocks" : cptr * int -> unit;
    val set_discrete_blocks : 'a t -> int -> unit
	= fn self => fn blocks =>
	     GObject.withPtr
	       (self, fn self => set_discrete_blocks_ (self, blocks))
    val set_activity_step_ : cptr * int -> unit
	= _import "gtk_progress_bar_set_activity_step" : cptr * int -> unit;
    val set_activity_step : 'a t -> int -> unit
	= fn self => fn step =>
	     GObject.withPtr (self, fn self => set_activity_step_ (self, step))
    val set_activity_blocks_ : cptr * int -> unit
	= _import "gtk_progress_bar_set_activity_blocks" : cptr * int -> unit;
    val set_activity_blocks : 'a t -> int -> unit
	= fn self => fn blocks =>
	     GObject.withPtr
...
structure Preview :> Preview = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toPreview obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_preview_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val uninit_ : unit -> unit = _import "gtk_preview_uninit" : unit -> unit;
	...
	= _import "gtk_preview_set_color_cube" : int * int * int * int -> unit;
    val set_color_cube : int -> int -> int -> int -> unit
...
structure OldEditable :> OldEditable = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toOldEditable obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_old_editable_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val changed_ : cptr -> unit
...
structure Misc :> Misc = struct
    ...
    fun inherit w con = let val con = let val ptr = con () in fn () => ptr end
			...
			in Widget.inherit witness con end
    fun make ptr = inherit () (fn () => ptr)
    fun toMisc obj = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_misc_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn xpad => fn ypad =>
	     GObject.withPtr (self, fn self => set_padding_ (self, xpad, ypad))
end
signature Pixmap = sig
    type base
    type 'a pixmap_t
...
structure Pixmap :> Pixmap = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toPixmap obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_pixmap_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Arrow :> Arrow = struct
    ...
    fun toArrow obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_arrow_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : int * int -> cptr = _import "gtk_arrow_new" : int * int -> cptr;
    val new : arrowtype -> shadowtype -> base t
...
structure Image :> Image = struct
    ...
    fun toImage obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_image_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val new_from_file : string -> base t
	= fn filename => make (new_from_file_ (CString.fromString filename))
    val new_from_stock_ : CString.cstring * int -> cptr
	= _import "gtk_image_new_from_stock" : CString.cstring * int -> cptr;
    val new_from_stock : string -> icon_size -> base t
	= fn stock_id => fn size =>
	...
	= _import "gtk_image_set_from_file" : cptr * CString.cstring -> unit;
    val set_from_file : 'a t -> string option -> unit
	= fn self => fn filename =>
	     GObject.withPtr
	       (self, 
	...
	= fn self =>
	     GObject.withPtr
	       (self, fn self => set_from_file_ (self, CString.fromString ""))
	...
	= _import "gtk_image_set_from_icon_set" : cptr * cptr * int -> unit;
    val set_from_icon_set : 'a t -> icon_set -> icon_size -> unit
    ...
    val get_storagetype : 'a t -> imagetype
	= fn self => GObject.withPtr (self, fn self => get_storagetype_ self)
    val menu_item_get_type_ : unit -> int
	= _import "gtk_image_menu_item_get_type" : unit -> int;
    val menu_item_get_type : unit -> int
	= fn dummy => menu_item_get_type_ dummy
end
signature Label = sig
    ...
    val move_cursor_sig : (unit -> int -> bool -> unit) -> 'a t Signal.signal
...
structure Label :> Label = struct
    ...
    fun toLabel obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_label_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : CString.cstring -> cptr
	...
	= fn self => fn str =>
	     GObject.withPtr
	       (self, fn self => set_markup_ (self, CString.fromString str))
    val set_use_markup_ : cptr * bool -> unit
	= _import "gtk_label_set_use_markup" : cptr * bool -> unit;
    val set_use_markup : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr (self, fn self => set_use_markup_ (self, setting))
    val get_use_markup_ : cptr -> bool
	= _import "gtk_label_get_use_markup" : cptr -> bool;
    val get_use_markup : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_use_markup_ self)
    ...
    val get_use_underline : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_use_underline_ self)
    ...
    val set_selectable : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr (self, fn self => set_selectable_ (self, setting))
    val get_selectable_ : cptr -> bool
	= _import "gtk_label_get_selectable" : cptr -> bool;
    val get_selectable : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_selectable_ self)
    val select_region_ : cptr * int * int -> unit
...
structure AccelLabel :> AccelLabel = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toAccelLabel obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_accel_label_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : CString.cstring -> cptr
    ...
    val accelerator_width : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => accelerator_width_ self)
    ...
    val get_accel_width : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_accel_width_ self)
...
structure Invisible :> Invisible = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toInvisible obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_invisible_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
signature Entry = sig
    ...
    val delete_from_cursor_sig : (unit -> int -> unit) -> 'a t Signal.signal
...
structure Entry :> Entry = struct
    ...
    fun toEntry obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_entry_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_visibility : 'a t -> bool -> unit
	= fn self => fn visible =>
	     GObject.withPtr (self, fn self => set_visibility_ (self, visible))
    val get_visibility_ : cptr -> bool
	= _import "gtk_entry_get_visibility" : cptr -> bool;
    val get_visibility : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_visibility_ self)
    val set_invisible_char_ : cptr * char -> unit
	= _import "gtk_entry_set_invisible_char" : cptr * char -> unit;
    val set_invisible_char : 'a t -> char -> unit
	= fn self => fn ch =>
	     GObject.withPtr (self, fn self => set_invisible_char_ (self, ch))
    ...
    val set_has_frame : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr (self, fn self => set_has_frame_ (self, setting))
    ...
    val get_max_length : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_max_length_ self)
    ...
    val get_width_chars : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_width_chars_ self)
    val set_text_ : cptr * CString.cstring -> unit
	...
	= fn self => fn text =>
	     GObject.withPtr
	       (self, fn self => append_text_ (self, CString.fromString text))
    val prepend_text_ : cptr * CString.cstring -> unit
	= _import "gtk_entry_prepend_text" : cptr * CString.cstring -> unit;
    val prepend_text : 'a t -> string -> unit
	= fn self => fn text =>
	     GObject.withPtr
	       (self, fn self => prepend_text_ (self, CString.fromString text))
    local open Signal
	  infixr -->
    in
      val move_cursor_sig : (unit -> int -> bool -> unit) -> 'a t Signal.signal
	  = fn f => signal "move-cursor" false
			   (unit --> int --> bool --> return_void) f
      val insert_at_cursor_sig : (char -> unit) -> 'a t Signal.signal
	  = fn f => signal "insert-at-cursor" false (char --> return_void) f
      val delete_from_cursor_sig : (unit -> int -> unit) -> 'a t Signal.signal
      ...
      val toggle_overwrite_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "toggle-overwrite" false (void --> return_void) f
      val populate_popup_sig : (unit -> unit) -> 'a t Signal.signal
	  = fn f => signal "populate-popup" false (unit --> return_void) f
      val activate_sig : (unit -> unit) -> 'a t Signal.signal
...
structure SpinButton :> SpinButton = struct
    type cptr = GObject.cptr
    type base = unit
	...
	= let val (x0, x1) = (ref 0, ref 0)
	  in get_update_policy_ (x0, x1); (! x0, ! x1)  end
    val get_type_ : unit -> int
	= _import "gtk_spin_button_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_value_as_int : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_value_as_int_ self)
    val set_value_ : cptr * real -> unit
    ...
    val set_numeric : 'a t -> bool -> unit
	= fn self => fn numeric =>
	     GObject.withPtr (self, fn self => set_numeric_ (self, numeric))
	...
	= _import "gtk_spin_button_set_snap_to_ticks" : cptr * bool -> unit;
    val set_snap_to_ticks : 'a t -> bool -> unit
    ...
    val get_snap_to_ticks : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_snap_to_ticks_ self)
...
structure DrawingArea :> DrawingArea = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toDrawingArea obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_drawing_area_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_drawing_area_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val size_ : cptr * int * int -> unit
...
structure Curve :> Curve = struct
    ...
    fun toCurve obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_curve_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn min_x => fn max_x => fn min_y => fn max_y =>
	     GObject.withPtr
	       (self, fn self => set_range_ (self, min_x, max_x, min_y, max_y))
    ...
    in val curve_type_changed_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "curve-type-changed" false (void --> return_void) f
    end
end
...
structure Container :> Container = struct
    ...
    fun toContainer obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_container_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_border_width : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_border_width_ self)
    val add_ : cptr * cptr -> unit
    ...
    val get_resize_mode : 'a t -> resize_mode
	= fn self => GObject.withPtr (self, fn self => get_resize_mode_ self)
    ...
    val unset_focus_chain : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => unset_focus_chain_ self)
    val set_reallocate_redraws_ : cptr * bool -> unit
	= _import "gtk_container_set_reallocate_redraws" : cptr * bool -> unit;
    val set_reallocate_redraws : 'a t -> bool -> unit
	= fn self => fn needs_redraws =>
	     GObject.withPtr
	       (self, fn self => set_reallocate_redraws_ (self, needs_redraws))
	...
	= _import "gtk_container_set_focus_vadjustment" : cptr * cptr -> unit;
    val set_focus_vadjustment : 'a t -> 'b Adjustment.t -> unit
	= fn self => fn adjustment =>
	     GObject.withPtr
	       (self, 
	...
	= _import "gtk_container_set_focus_hadjustment" : cptr * cptr -> unit;
    val set_focus_hadjustment : 'a t -> 'b Adjustment.t -> unit
	= fn self => fn adjustment =>
	     GObject.withPtr
	       (self, 
    ...
    val resize_children : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => resize_children_ self)
    val childtype_ : cptr -> int
	= _import "gtk_container_child_type" : cptr -> int;
    val childtype : 'a t -> int
    ...
    in val add_sig : (unit -> unit) -> 'a t Signal.signal
       ...
       val set_focus_child_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "set-focus-child" false (unit --> return_void) f
    end
end
signature TreeView = sig
    ...
    val get_reorderable : 'a t -> bool
    val set_cursor
      : 'a t -> tree_path -> 'b TreeViewColumn.t option -> bool option -> unit
    val set_cursor' : 'a t -> tree_path -> unit
    val get_cursor : 'a t -> tree_path -> 'b TreeViewColumn.t -> unit
    ...
    val test_collapse_row_sig : (unit -> unit -> bool) -> 'a t Signal.signal
...
structure TreeView :> TreeView = struct
	...
	= let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
	  in get_drop_position_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
    val get_type_ : unit -> int
	= _import "gtk_tree_view_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self =>
	     TreeModel.inherit
	       () (fn () => GObject.withPtr (self, fn self => get_model_ self))
	...
	= _import "gtk_tree_view_set_headers_visible" : cptr * bool -> unit;
    val set_headers_visible : 'a t -> bool -> unit
	= fn self => fn headers_visible =>
	     GObject.withPtr
	       (self, fn self => set_headers_visible_ (self, headers_visible))
    val columns_autosize_ : cptr -> unit
	= _import "gtk_tree_view_columns_autosize" : cptr -> unit;
    val columns_autosize : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => columns_autosize_ self)
    val set_headers_clickable_ : cptr * bool -> unit
	= _import "gtk_tree_view_set_headers_clickable" : cptr * bool -> unit;
    val set_headers_clickable : 'a t -> bool -> unit
	= fn self => fn active =>
	     GObject.withPtr
    ...
    val set_rules_hint : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr (self, fn self => set_rules_hint_ (self, setting))
    val get_rules_hint_ : cptr -> bool
	= _import "gtk_tree_view_get_rules_hint" : cptr -> bool;
    val get_rules_hint : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_rules_hint_ self)
	...
	= _import "gtk_tree_view_set_expander_column" : cptr * cptr -> unit;
    val set_expander_column : 'a t -> 'b TreeViewColumn.t -> unit
	= fn self => fn column =>
	     GObject.withPtr
	       (self, 
		fn self => GObject.withPtr (column, 
	...
	= _import "gtk_tree_view_scroll_to_point" : cptr * int * int -> unit;
    val scroll_to_point : 'a t -> int -> int -> unit
    ...
    val scroll_to_cell : 'a t -> tree_path -> 'b TreeViewColumn.t option 
		      -> bool option -> real option -> real option
			 -> unit
	= fn self => fn path => fn column => fn use_align => fn row_align => 
	  fn col_align =>
	     GObject.withPtr
	       (self, 
		fn self => GObject.withOpt
	...
	= fn self => fn path =>
		...
		fn self => scroll_to_cell_
			     (self, path, GObject.null, false, 0.0, 0.0))
    val row_activated_ : cptr * cptr * cptr -> unit
	= _import "gtk_tree_view_row_activated" : cptr * cptr * cptr -> unit;
    val row_activated : 'a t -> tree_path -> 'b TreeViewColumn.t -> unit
	...
	= fn self => fn path => fn focus_column => fn start_editing =>
		...
		fn self => GObject.withOpt
			     (focus_column, 
			      fn focus_column =>
				 set_cursor_ (self, path, focus_column, 
					      getOpt (start_editing, false))))
    val set_cursor' : 'a t -> tree_path -> unit
	= fn self => fn path =>
	     GObject.withPtr
	       (self, fn self => set_cursor_ (self, path, GObject.null, false))
    val get_cursor_ : cptr * cptr * cptr -> unit
	= _import "gtk_tree_view_get_cursor" : cptr * cptr * cptr -> unit;
    val get_cursor : 'a t -> tree_path -> 'b TreeViewColumn.t -> unit
	= fn self => fn path => fn focus_column =>
	     GObject.withPtr
	       (self, 
		fn self => GObject.withPtr
			     (focus_column, 
			      fn focus_column =>
				 get_cursor_ (self, path, focus_column)))
    ...
    val get_enable_search : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_enable_search_ self)
    val get_search_column_ : cptr -> int
	= _import "gtk_tree_view_get_search_column" : cptr -> int;
    val get_search_column : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_search_column_ self)
	...
	: (unit -> unit -> unit) -> 'a t Signal.signal
      ...
      val row_expanded_sig : (unit -> unit -> unit) -> 'a t Signal.signal
	  = fn f =>
	       signal "row-expanded" false (unit --> unit --> return_void) f
      val row_collapsed_sig : (unit -> unit -> unit) -> 'a t Signal.signal
      ...
      val move_cursor_sig : (unit -> int -> bool) -> 'a t Signal.signal
	  = fn f => signal "move-cursor" false (unit --> int --> return_bool) f
      val select_all_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "select-all" false (void --> return_bool) f
      val unselect_all_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "unselect-all" false (void --> return_bool) f
      val select_cursor_row_sig : (bool -> bool) -> 'a t Signal.signal
	  = fn f => signal "select-cursor-row" false (bool --> return_bool) f
      val toggle_cursor_row_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "toggle-cursor-row" false (void --> return_bool) f
      val expand_collapse_cursor_row_sig
	: (bool -> bool -> bool -> bool) -> 'a t Signal.signal
      ...
      val select_cursor_parent_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f =>
	       signal "select-cursor-parent" false (void --> return_bool) f
      val start_interactive_search_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "start-interactive-search" false
			   (void --> return_bool) f
    end
end
signature Toolbar = sig
    type base
    type 'a toolbar_t
    ...
    val insert_widget
      : 'a t -> 'b Widget.t -> string option -> string option -> int -> unit
...
structure Toolbar :> Toolbar = struct
    type cptr = GObject.cptr
    type base = unit
	...
	= let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
	  in get_style_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
    type childtype = int
    val get_childtype_
      : int ref * int ref * int ref * int ref * int ref -> unit
	...
	= _import "mgtk_get_gtk_toolbar_space_style"
		  : int ref * int ref -> unit;
    val (SPACE_EMPTY, SPACE_LINE)
	= let val (x0, x1) = (ref 0, ref 0)
	  in get_space_style_ (x0, x1); (! x0, ! x1)  end
    val get_type_ : unit -> int = _import "gtk_toolbar_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val insert_space : 'a t -> int -> unit
	= fn self => fn position =>
	     GObject.withPtr (self, fn self => insert_space_ (self, position))
    val remove_space_ : cptr * int -> unit
	= _import "gtk_toolbar_remove_space" : cptr * int -> unit;
    val remove_space : 'a t -> int -> unit
	= fn self => fn position =>
	     GObject.withPtr (self, fn self => remove_space_ (self, position))
    val append_widget_
      : cptr * cptr * CString.cstring * CString.cstring -> unit
    ...
    val append_widget
      : 'a t -> 'b Widget.t -> string option -> string option -> unit
	= fn self => fn widget => fn tooltip_text => fn tooltip_private_text =>
	     GObject.withPtr
	       (self, 
		fn self =>
		   GObject.withPtr
			 ...
			 append_widget_
			   (self, widget, 
			    CString.fromString (getOpt (tooltip_text, "")), 
			    CString.fromString
    ...
    val set_tooltips : 'a t -> bool -> unit
	= fn self => fn enable =>
	     GObject.withPtr (self, fn self => set_tooltips_ (self, enable))
    ...
    val unset_icon_size : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => unset_icon_size_ self)
    val get_orientation_ : cptr -> int
    ...
    in val orientation_changed_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f =>
		signal "orientation-changed" false (unit --> return_void) f
       val style_changed_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "style-changed" false (unit --> return_void) f
    end
end
signature TextView = sig
    type base
    type 'a textview_t
    ...
    val get_buffer : 'a t -> base TextBuffer.t
    val scroll_toiter
      : 'a t -> textiter -> real -> bool option -> real option -> real option
	-> bool
    ...
    val getiter_at_location : 'a t -> textiter -> int -> int -> unit
...
structure TextView :> TextView = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTextView obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_text_view_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val new_withbuffer : 'a TextBuffer.t option -> base t
	= fn buffer => make (GObject.withOpt
	...
	= fn self => fn iter => fn within_margin =>
		...
		fn self => scroll_toiter_
			     (self, iter, within_margin, false, 0.5, 0.5))
	...
	= fn self => fn mark => fn within_margin =>
	     GObject.withPtr
	       (self, 
		fn self => GObject.withPtr (mark, 
					    fn mark => scroll_to_mark_
							 (self, mark, 
							  within_margin, 
							  false, 0.5, 0.5)))
    val scroll_mark_onscreen_ : cptr * cptr -> unit
	= _import "gtk_text_view_scroll_mark_onscreen" : cptr * cptr -> unit;
    val scroll_mark_onscreen : 'a t -> 'b TextMark.t -> unit
	= fn self => fn mark =>
	     GObject.withPtr
	       (self, 
	...
	= _import "gtk_text_view_get_iter_at_location"
		  : cptr * cptr * int * int -> unit;
    val getiter_at_location : 'a t -> textiter -> int -> int -> unit
	= fn self => fn iter => fn x => fn y =>
	     GObject.withPtr
	       (self, fn self => getiter_at_location_ (self, iter, x, y))
	...
	= _import "gtk_text_view_get_border_window_size" : cptr * int -> int;
    val get_border_window_size : 'a t -> text_window_type_t -> int
	= fn self => fn typ =>
	     GObject.withPtr
	       (self, fn self => get_border_window_size_ (self, typ))
    val forward_display_line_ : cptr * cptr -> bool
	= _import "gtk_text_view_forward_display_line" : cptr * cptr -> bool;
    val forward_display_line : 'a t -> textiter -> bool
	= fn self => fn iter =>
	     GObject.withPtr
	       (self, fn self => forward_display_line_ (self, iter))
    val backward_display_line_ : cptr * cptr -> bool
	= _import "gtk_text_view_backward_display_line" : cptr * cptr -> bool;
    val backward_display_line : 'a t -> textiter -> bool
	= fn self => fn iter =>
	     GObject.withPtr
	...
	= _import "gtk_text_view_starts_display_line" : cptr * cptr -> bool;
    val starts_display_line : 'a t -> textiter -> bool
	= fn self => fn iter =>
	     GObject.withPtr
	       (self, fn self => starts_display_line_ (self, iter))
    val move_visually_ : cptr * cptr * int -> bool
	= _import "gtk_text_view_move_visually" : cptr * cptr * int -> bool;
    val move_visually : 'a t -> textiter -> int -> bool
	...
	= fn self => fn child => fn which_window => fn xpos => fn ypos =>
		...
		fn self => GObject.withPtr
				 ...
				 add_child_in_window_
				   (self, child, which_window, xpos, ypos)))
    val move_child_ : cptr * cptr * int * int -> unit
	= _import "gtk_text_view_move_child" : cptr * cptr * int * int -> unit;
    val move_child : 'a t -> 'b Widget.t -> int -> int -> unit
	= fn self => fn child => fn xpos => fn ypos =>
		...
		fn self => GObject.withPtr
			     (child, 
			      fn child => move_child_ (self, child, 
						       xpos, ypos)))
    ...
    val set_editable : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr (self, fn self => set_editable_ (self, setting))
    val get_editable_ : cptr -> bool
	= _import "gtk_text_view_get_editable" : cptr -> bool;
    val get_editable : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_editable_ self)
    val set_pixels_above_lines_ : cptr * int -> unit
	= _import "gtk_text_view_set_pixels_above_lines" : cptr * int -> unit;
    val set_pixels_above_lines : 'a t -> int -> unit
	...
	= _import "gtk_text_view_set_pixels_below_lines" : cptr * int -> unit;
    val set_pixels_below_lines : 'a t -> int -> unit
	...
	= _import "gtk_text_view_set_pixels_inside_wrap" : cptr * int -> unit;
    val set_pixels_inside_wrap : 'a t -> int -> unit
    ...
    val get_justification : 'a t -> justification
	= fn self => GObject.withPtr (self, fn self => get_justification_ self)
    ...
    val get_left_margin : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_left_margin_ self)
    ...
    val get_right_margin : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_right_margin_ self)
...
structure Table :> Table = struct
    ...
    fun toTable obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_table_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn rows => fn columns =>
	     GObject.withPtr (self, fn self => resize_ (self, rows, columns))
    ...
    val get_row_spacing : 'a t -> int -> int
	= fn self => fn row =>
	     GObject.withPtr (self, fn self => get_row_spacing_ (self, row))
    ...
    val get_col_spacing : 'a t -> int -> int
	= fn self => fn column =>
	     GObject.withPtr (self, fn self => get_col_spacing_ (self, column))
    ...
    val get_homogeneous : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_homogeneous_ self)
end
...
structure Socket :> Socket = struct
    ...
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val get_type_ : unit -> int = _import "gtk_socket_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    local open Signal
	  infixr -->
...
structure Paned :> Paned = struct
    ...
    fun toPaned obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_paned_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn child =>
		...
		fn self =>
		   GObject.withPtr
		     (child, fn child => pack1_ (self, child, false, true)))
    ...
    in
      val cycle_child_focus_sig : (bool -> bool) -> 'a t Signal.signal
	  = fn f => signal "cycle-child-focus" false (bool --> return_bool) f
      val toggle_handle_focus_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "toggle-handle-focus" false (void --> return_bool) f
      val move_handle_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "move-handle" false (unit --> return_bool) f
      val cycle_handle_focus_sig : (bool -> bool) -> 'a t Signal.signal
	  = fn f => signal "cycle-handle-focus" false (bool --> return_bool) f
      val accept_position_sig : (unit -> bool) -> 'a t Signal.signal
...
structure VPaned :> VPaned = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toVPaned obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_vpaned_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_vpaned_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
end
signature HPaned = sig
    type base
    type 'a hpaned_t
...
structure HPaned :> HPaned = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toHPaned obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_hpaned_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_hpaned_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
end
signature Notebook = sig
    type base
    type 'a notebook_t
...
structure Notebook :> Notebook = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    val (TAB_FIRST, TAB_LAST) = let val (x0, x1) = (ref 0, ref 0)
				in get_tab_ (x0, x1); (! x0, ! x1)  end
    val get_type_ : unit -> int
	= _import "gtk_notebook_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val remove_page : 'a t -> int -> unit
	= fn self => fn page_num =>
	     GObject.withPtr (self, fn self => remove_page_ (self, page_num))
    val get_current_page_ : cptr -> int
	= _import "gtk_notebook_get_current_page" : cptr -> int;
    val get_current_page : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_current_page_ self)
    ...
    val get_show_border : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_show_border_ self)
	...
	= _import "gtk_notebook_set_homogeneous_tabs" : cptr * bool -> unit;
    val set_homogeneous_tabs : 'a t -> bool -> unit
	= fn self => fn homogeneous =>
	     GObject.withPtr
    ...
    val get_scrollable : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_scrollable_ self)
	...
	= _import "gtk_notebook_set_tab_label" : cptr * cptr * cptr -> unit;
    val set_tab_label : 'a t -> 'b Widget.t -> 'c Widget.t -> unit
	= fn self => fn child => fn tab_label =>
	     GObject.withPtr
	       (self, 
	...
	= _import "gtk_notebook_get_tab_label_text" : cptr * cptr -> CString.t;
    val get_tab_label_text : 'a t -> 'b Widget.t -> string
	= fn self => fn child =>
	     GObject.withPtr
	       (self, 
	...
	= _import "gtk_notebook_set_menu_label" : cptr * cptr * cptr -> unit;
    val set_menu_label : 'a t -> 'b Widget.t -> 'c Widget.t -> unit
	...
	= fn self => fn child => fn expand => fn fill => fn pack_type =>
		...
		fn self => GObject.withPtr
			     (child, 
			      fn child => set_tab_label_packing_
    ...
    in
      ...
      val switch_page_sig : (unit -> int -> unit) -> 'a t Signal.signal
	  = fn f => signal "switch-page" false (unit --> int --> return_void) f
      val focus_tab_sig : (unit -> bool) -> 'a t Signal.signal
	  = fn f => signal "focus-tab" false (unit --> return_bool) f
      val select_page_sig : (bool -> bool) -> 'a t Signal.signal
	  = fn f => signal "select-page" false (bool --> return_bool) f
      val change_current_page_sig : (int -> unit) -> 'a t Signal.signal
	  = fn f => signal "change-current-page" false (int --> return_void) f
    end
end
signature MenuShell = sig
    type base
    type 'a menushell_t
...
structure MenuShell :> MenuShell = struct
    type cptr = GObject.cptr
    type base = unit
	...
	= fn self => fn menu_item =>
		...
		fn self => GObject.withPtr
			     (menu_item, 
			      fn menu_item => select_item_ (self, menu_item)))
	...
	= _import "gtk_menu_shell_activate_item" : cptr * cptr * bool -> unit;
    val activate_item : 'a t -> 'b Widget.t -> bool -> unit
    ...
    in val deactivate_sig : (unit -> unit) -> 'a t Signal.signal
       ...
       val activate_current_sig : (bool -> unit) -> 'a t Signal.signal
	   = fn f => signal "activate-current" false (bool --> return_void) f
       val cancel_sig : (unit -> unit) -> 'a t Signal.signal
...
signature Menu = sig
    ...
    val get_title : 'a t -> string
    val reorder_child : 'a t -> 'b Widget.t -> int -> unit
    val bar_get_type : unit -> int
    val item_get_type : unit -> int
    val shell_get_type : unit -> int
end
structure Menu :> Menu = struct
    type cptr = GObject.cptr
    type base = unit
    type 'a menu_t = unit
    type 'a t = 'a menu_t MenuShell.t
    ...
    fun make ptr = inherit () (fn () => ptr)
    fun toMenu obj = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    type directiontype = int
	...
	= let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
	  in get_directiontype_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
    val get_type_ : unit -> int = _import "gtk_menu_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val popdown_ : cptr -> unit = _import "gtk_menu_popdown" : cptr -> unit;
    val popdown : 'a t -> unit
	...
	= _import "gtk_menu_set_accel_path" : cptr * CString.cstring -> unit;
    val set_accel_path : 'a t -> string -> unit
    ...
    val get_tearoff_state : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_tearoff_state_ self)
    val set_title_ : cptr * CString.cstring -> unit
	...
	= fn self => fn child => fn position =>
		...
		fn self => GObject.withPtr
			     (child, 
			      fn child => reorder_child_
					    (self, child, position)))
    val bar_get_type_ : unit -> int
	= _import "gtk_menu_bar_get_type" : unit -> int;
    val bar_get_type : unit -> int = fn dummy => bar_get_type_ dummy
    val item_get_type_ : unit -> int
	= _import "gtk_menu_item_get_type" : unit -> int;
    val item_get_type : unit -> int = fn dummy => item_get_type_ dummy
    val shell_get_type_ : unit -> int
	= _import "gtk_menu_shell_get_type" : unit -> int;
    val shell_get_type : unit -> int = fn dummy => shell_get_type_ dummy
end
signature MenuBar = sig
    type base
    type 'a menubar_t
...
structure MenuBar :> MenuBar = struct
    type cptr = GObject.cptr
    type base = unit
...
structure List :> List = struct
    ...
    fun inherit w con = let val con = let val ptr = con () in fn () => ptr end
			...
			in Container.inherit witness con end
    fun make ptr = inherit () (fn () => ptr)
    fun toList obj = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_list_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val clear_items : 'a t -> int -> int -> unit
	= fn self => fn start => fn en =>
	     GObject.withPtr (self, fn self => clear_items_ (self, start, en))
    ...
    val start_selection : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => start_selection_ self)
    ...
    val toggle_add_mode : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => toggle_add_mode_ self)
    val toggle_focus_row_ : cptr -> unit
	= _import "gtk_list_toggle_focus_row" : cptr -> unit;
    val toggle_focus_row : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => toggle_focus_row_ self)
    ...
    val undo_selection : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => undo_selection_ self)
    ...
    val item_get_type_ : unit -> int
	= _import "gtk_list_item_get_type" : unit -> int;
    val item_get_type : unit -> int = fn dummy => item_get_type_ dummy
    val store_get_type_ : unit -> int
	= _import "gtk_list_store_get_type" : unit -> int;
    val store_get_type : unit -> int = fn dummy => store_get_type_ dummy
    local open Signal
	  infixr -->
    in val selection_changed_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "selection-changed" false (void --> return_void) f
       val select_child_sig : (unit -> unit) -> 'a t Signal.signal
...
structure Layout :> Layout = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toLayout obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_layout_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_size : 'a t -> int -> int -> unit
	= fn self => fn width => fn height =>
	     GObject.withPtr (self, fn self => set_size_ (self, width, height))
    val set_hadjustment_ : cptr * cptr -> unit
    ...
    val freeze_ : cptr -> unit = _import "gtk_layout_freeze" : cptr -> unit;
    val freeze : 'a t -> unit
...
structure Fixed :> Fixed = struct
    ...
    fun toFixed obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_fixed_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_has_window : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_has_window_ self)
end
signature Bin = sig
    type base
    type 'a bin_t
...
structure Bin :> Bin = struct
    ...
    fun inherit w con = let val con = let val ptr = con () in fn () => ptr end
			...
			in Container.inherit witness con end
    fun make ptr = inherit () (fn () => ptr)
    fun toBin obj = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_bin_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val get_child_ : cptr -> cptr = _import "gtk_bin_get_child" : cptr -> cptr;
    val get_child : 'a t -> base Widget.t
	= fn self =>
	     Widget.inherit
	       () (fn () => GObject.withPtr (self, fn self => get_child_ self))
end
signature Viewport = sig
    type base
    type 'a viewport_t
...
structure Viewport :> Viewport = struct
    ...
    fun toViewport obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_viewport_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : cptr * cptr -> cptr
    ...
    val get_shadowtype : 'a t -> shadowtype
	= fn self => GObject.withPtr (self, fn self => get_shadowtype_ self)
    local open Signal
	  infixr -->
    in val set_scroll_adjustments_sig
	 : (unit -> unit -> unit) -> 'a t Signal.signal
...
structure ScrolledWindow :> ScrolledWindow = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toScrolledWindow obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_scrolled_window_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : cptr * cptr -> cptr
	...
	= fn dummy => make (new_ (GObject.null, GObject.null))
    val set_hadjustment_ : cptr * cptr -> unit
	= _import "gtk_scrolled_window_set_hadjustment" : cptr * cptr -> unit;
    val set_hadjustment : 'a t -> 'b Adjustment.t -> unit
	= fn self => fn hadjustment =>
		...
		fn self => GObject.withPtr (hadjustment, 
					    fn hadjustment =>
						 ...
						 (self, hadjustment)))
    val set_vadjustment_ : cptr * cptr -> unit
	= _import "gtk_scrolled_window_set_vadjustment" : cptr * cptr -> unit;
    val set_vadjustment : 'a t -> 'b Adjustment.t -> unit
	= fn self => fn hadjustment =>
	     GObject.withPtr
	       (self, 
	...
	= _import "gtk_scrolled_window_set_policy" : cptr * int * int -> unit;
    val set_policy : 'a t -> policytype -> policytype -> unit
    ...
    val set_shadowtype_ : cptr * int -> unit
	= _import "gtk_scrolled_window_set_shadow_type" : cptr * int -> unit;
    val set_shadowtype : 'a t -> shadowtype -> unit
	= fn self => fn typ =>
	     GObject.withPtr (self, fn self => set_shadowtype_ (self, typ))
    val get_shadowtype_ : cptr -> int
    ...
    in val scroll_child_sig : (unit -> bool -> unit) -> 'a t Signal.signal
	   = fn f =>
		signal "scroll-child" false (unit --> bool --> return_void) f
       val move_focus_out_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "move-focus-out" false (unit --> return_void) f
    end
end
...
structure Item :> Item = struct
    ...
    fun inherit w con = let val con = let val ptr = con () in fn () => ptr end
			...
			in Bin.inherit witness con end
    fun make ptr = inherit () (fn () => ptr)
    fun toItem obj = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_item_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val select_ : cptr -> unit = _import "gtk_item_select" : cptr -> unit;
    val select : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => select_ self)
    val deselect_ : cptr -> unit = _import "gtk_item_deselect" : cptr -> unit;
    val deselect : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => deselect_ self)
    val toggle_ : cptr -> unit = _import "gtk_item_toggle" : cptr -> unit;
    val toggle : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => toggle_ self)
    val factory_get_type_ : unit -> int
	= _import "gtk_item_factory_get_type" : unit -> int;
    val factory_get_type : unit -> int = fn dummy => factory_get_type_ dummy
	...
	= fn widget =>
	     GObject.withPtr
	       (widget, fn widget => factory_popup_data_from_widget_ widget)
...
structure MenuItem :> MenuItem = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    val new_with_mnemonic_ : CString.cstring -> cptr
	= _import "gtk_menu_item_new_with_mnemonic" : CString.cstring -> cptr;
    val new_with_mnemonic : string -> base t
    ...
    val remove_submenu : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => remove_submenu_ self)
    val select_ : cptr -> unit = _import "gtk_menu_item_select" : cptr -> unit;
    val select : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => select_ self)
    val deselect_ : cptr -> unit
	...
	= _import "gtk_menu_item_toggle_size_allocate" : cptr * int -> unit;
    val toggle_size_allocate : 'a t -> int -> unit
	= fn self => fn allocation =>
	     GObject.withPtr
	       (self, fn self => toggle_size_allocate_ (self, allocation))
    val set_right_justified_ : cptr * bool -> unit
	= _import "gtk_menu_item_set_right_justified" : cptr * bool -> unit;
    val set_right_justified : 'a t -> bool -> unit
	= fn self => fn right_justified =>
	     GObject.withPtr
	       (self, fn self => set_right_justified_ (self, right_justified))
    ...
    in
      ...
      val toggle_size_request_sig : (int -> unit) -> 'a t Signal.signal
	  = fn f => signal "toggle-size-request" false (int --> return_void) f
      val toggle_size_allocate_sig : (int -> unit) -> 'a t Signal.signal
	  = fn f => signal "toggle-size-allocate" false (int --> return_void) f
    end
end
signature TearoffMenuItem = sig
    type base
...
structure TearoffMenuItem :> TearoffMenuItem = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toTearoffMenuItem obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_tearoff_menu_item_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr
	= _import "gtk_tearoff_menu_item_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
end
signature SeparatorMenuItem = sig
    type base
...
structure SeparatorMenuItem :> SeparatorMenuItem = struct
    type cptr = GObject.cptr
    type base = unit
...
structure CheckMenuItem :> CheckMenuItem = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toCheckMenuItem obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_check_menu_item_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_check_menu_item_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val new_with_label_ : CString.cstring -> cptr
	...
	= fn self => fn is_active =>
	     GObject.withPtr (self, fn self => set_active_ (self, is_active))
    val get_active_ : cptr -> bool
	...
	= _import "gtk_check_menu_item_set_inconsistent" : cptr * bool -> unit;
    val set_inconsistent : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr
    ...
    val get_inconsistent : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_inconsistent_ self)
    val set_show_toggle_ : cptr * bool -> unit
	= _import "gtk_check_menu_item_set_show_toggle" : cptr * bool -> unit;
    val set_show_toggle : 'a t -> bool -> unit
	= fn self => fn always =>
	     GObject.withPtr (self, fn self => set_show_toggle_ (self, always))
    val set_state_ : cptr * bool -> unit
	= _import "gtk_check_menu_item_set_state" : cptr * bool -> unit;
    val set_state : 'a t -> bool -> unit
	= fn self => fn is_active =>
	     GObject.withPtr (self, fn self => set_state_ (self, is_active))
    local open Signal
	  infixr -->
...
structure RadioMenuItem :> RadioMenuItem = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toRadioMenuItem obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_radio_menu_item_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
end
signature ImageMenuItem = sig
    type base
...
structure ImageMenuItem :> ImageMenuItem = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toImageMenuItem obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val new_ : unit -> cptr = _import "gtk_image_menu_item_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val new_with_label_ : CString.cstring -> cptr
...
structure ListItem :> ListItem = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    val new_with_label : string -> base t
	= fn label => make (new_with_label_ (CString.fromString label))
    val select_ : cptr -> unit = _import "gtk_list_item_select" : cptr -> unit;
    val select : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => select_ self)
    val deselect_ : cptr -> unit
    ...
    local open Signal
	  infixr -->
    in val select_all_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "select-all" false (void --> return_void) f
       val unselect_all_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "unselect-all" false (void --> return_void) f
       val toggle_focus_row_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "toggle-focus-row" false (void --> return_void) f
       val undo_selection_sig : (unit -> unit) -> 'a t Signal.signal
...
structure HandleBox :> HandleBox = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toHandleBox obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_handle_box_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= _import "gtk_handle_box_set_handle_position" : cptr * int -> unit;
    val set_handle_position : 'a t -> positiontype -> unit
	= fn self => fn position =>
	     GObject.withPtr
...
structure Frame :> Frame = struct
    ...
    fun toFrame obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_frame_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : CString.cstring -> cptr
	...
	= fn self => fn label =>
	     GObject.withPtr
	       (self, 
		fn self => set_label_
			     (self, CString.fromString (getOpt (label, ""))))
    val set_label' : 'a t -> unit
	= fn self =>
	     GObject.withPtr
...
signature AspectFrame = sig
    ...
    val new : string option -> real option -> real option -> real option 
	   -> bool option
	      -> base t
    val new' : unit -> base t
    val set : 'a t -> real option -> real option -> real option -> bool option
	      -> unit
    val set' : 'a t -> unit
end
structure AspectFrame :> AspectFrame = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toAspectFrame obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_aspect_frame_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure EventBox :> EventBox = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toEventBox obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_event_box_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Alignment :> Alignment = struct
    ...
    fun toAlignment obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_alignment_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn xalign => fn yalign => fn xscale => fn yscale =>
	     GObject.withPtr
	       (self, fn self => set_ (self, xalign, yalign, xscale, yscale))
end
...
structure Button :> Button = struct
	...
	= let val (x0, x1, x2, x3) = (ref 0, ref 0, ref 0, ref 0)
	  in get_action_ (x0, x1, x2, x3); (! x0, ! x1, ! x2, ! x3)  end
    type box_style = int
    val get_box_style_
      : int ref * int ref * int ref * int ref * int ref -> unit
    ...
    val box_get_type_ : unit -> int
	= _import "gtk_button_box_get_type" : unit -> int;
    val box_get_type : unit -> int = fn dummy => box_get_type_ dummy
    val get_type_ : unit -> int = _import "gtk_button_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val new_from_stock : string -> base t
	= fn stock_id => make (new_from_stock_ (CString.fromString stock_id))
    val new_with_mnemonic_ : CString.cstring -> cptr
	= _import "gtk_button_new_with_mnemonic" : CString.cstring -> cptr;
    val new_with_mnemonic : string -> base t
	= fn label => make (new_with_mnemonic_ (CString.fromString label))
    val pressed_ : cptr -> unit = _import "gtk_button_pressed" : cptr -> unit;
    val pressed : 'a t -> unit
    ...
    val clicked_ : cptr -> unit = _import "gtk_button_clicked" : cptr -> unit;
    val clicked : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => clicked_ self)
    ...
    val set_relief : 'a t -> relief_style -> unit
	= fn self => fn newstyle =>
	     GObject.withPtr (self, fn self => set_relief_ (self, newstyle))
	...
	= fn self => fn label =>
	     GObject.withPtr
	       (self, fn self => set_label_ (self, CString.fromString label))
    val get_label_ : cptr -> CString.t
...
structure ToggleButton :> ToggleButton = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toToggleButton obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_toggle_button_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_toggle_button_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val new_with_label_ : CString.cstring -> cptr
	= _import "gtk_toggle_button_new_with_label" : CString.cstring -> cptr;
    val new_with_label : string -> base t
	= fn label => make (new_with_label_ (CString.fromString label))
    val new_with_mnemonic_ : CString.cstring -> cptr
	...
	= fn self => GObject.withPtr (self, fn self => toggled_ self)
    val set_inconsistent_ : cptr * bool -> unit
	= _import "gtk_toggle_button_set_inconsistent" : cptr * bool -> unit;
    val set_inconsistent : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr
	       (self, fn self => set_inconsistent_ (self, setting))
...
structure CheckButton :> CheckButton = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toCheckButton obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_check_button_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_check_button_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val new_with_label_ : CString.cstring -> cptr
	= _import "gtk_check_button_new_with_label" : CString.cstring -> cptr;
    val new_with_label : string -> base t
	= fn label => make (new_with_label_ (CString.fromString label))
    val new_with_mnemonic_ : CString.cstring -> cptr
...
structure RadioButton :> RadioButton = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toRadioButton obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_radio_button_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure OptionMenu :> OptionMenu = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toOptionMenu obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_option_menu_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self =>
	     Widget.inherit
	       () (fn () => GObject.withPtr (self, fn self => get_menu_ self))
...
signature Box = sig
    ...
    val get_type : unit -> int
    val pack_start
      : 'a t -> 'b Widget.t -> bool option -> bool option -> int option -> unit
...
structure Box :> Box = struct
    ...
    fun inherit w con = let val con = let val ptr = con () in fn () => ptr end
			...
			in Container.inherit witness con end
    fun make ptr = inherit () (fn () => ptr)
    fun toBox obj = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_box_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn child => fn expand => fn fill => fn padding =>
		...
		fn self => GObject.withPtr
			     (child, 
			      fn child => pack_start_ (self, child, 
						       getOpt (expand, true), 
						       getOpt (fill, true), 
						       getOpt (padding, 0))))
    val pack_start' : 'a t -> 'b Widget.t -> unit
	...
	= _import "gtk_box_pack_end" : cptr * cptr * bool * bool * int -> unit;
    val pack_end
      : 'a t -> 'b Widget.t -> bool option -> bool option -> int option -> unit
	= fn self => fn child => fn expand => fn fill => fn padding =>
	     GObject.withPtr
	...
	= fn self => fn child =>
		...
		fn self => GObject.withPtr
			     (child, 
			      fn child => pack_end_ (self, child, true, 
						     true, 0)))
...
structure VBox :> VBox = struct
    ...
    fun make ptr = inherit () (fn () => ptr)
    fun toVBox obj = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_vbox_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
signature ColorSelection = sig
    ...
    val set_update_policy : 'a t -> updatetype -> unit
    val dialog_get_type : unit -> int
    val color_changed_sig : (unit -> unit) -> 'a t Signal.signal
end
structure ColorSelection :> ColorSelection = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toColorSelection obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_color_selection_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_color_selection_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val get_has_opacity_control_ : cptr -> bool
	= _import "gtk_color_selection_get_has_opacity_control" : cptr -> bool;
    val get_has_opacity_control : 'a t -> bool
	= fn self => GObject.withPtr
	...
	= fn self => fn has_opacity =>
	     GObject.withPtr
	       (self, fn self => set_has_opacity_control_ (self, has_opacity))
    val get_has_palette_ : cptr -> bool
	= _import "gtk_color_selection_get_has_palette" : cptr -> bool;
    val get_has_palette : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_has_palette_ self)
    val set_has_palette_ : cptr * bool -> unit
	= _import "gtk_color_selection_set_has_palette" : cptr * bool -> unit;
    val set_has_palette : 'a t -> bool -> unit
	= fn self => fn has_palette =>
	     GObject.withPtr
	       (self, fn self => set_has_palette_ (self, has_palette))
    val set_current_alpha_ : cptr * int -> unit
	= _import "gtk_color_selection_set_current_alpha" : cptr * int -> unit;
    val set_current_alpha : 'a t -> int -> unit
	= fn self => fn alpha =>
	     GObject.withPtr
    ...
    val get_current_alpha : 'a t -> int
	= fn self => GObject.withPtr (self, fn self => get_current_alpha_ self)
    ...
    val set_update_policy_ : cptr * int -> unit
	= _import "gtk_color_selection_set_update_policy" : cptr * int -> unit;
    val set_update_policy : 'a t -> updatetype -> unit
	= fn self => fn policy =>
	     GObject.withPtr
	       (self, fn self => set_update_policy_ (self, policy))
    val dialog_get_type_ : unit -> int
	= _import "gtk_color_selection_dialog_get_type" : unit -> int;
    val dialog_get_type : unit -> int = fn dummy => dialog_get_type_ dummy
    local open Signal
	  infixr -->
...
structure FontSelection :> FontSelection = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toFontSelection obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_font_selection_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_font_selection_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
	...
	= fn self => fn fontname =>
	     GObject.withPtr
	       (self, 
		fn self => set_font_name_ (self, CString.fromString fontname))
    val get_preview_text_ : cptr -> CString.t
	= _import "gtk_font_selection_get_preview_text" : cptr -> CString.t;
    val get_preview_text : 'a t -> string
	= fn self => GObject.withPtr
		       (self, 
	...
	= fn self => fn text =>
	     GObject.withPtr (self, 
			      fn self => set_preview_text_
					   (self, CString.fromString text))
    val dialog_get_type_ : unit -> int
	= _import "gtk_font_selection_dialog_get_type" : unit -> int;
    val dialog_get_type : unit -> int = fn dummy => dialog_get_type_ dummy
end
signature GammaCurve = sig
    type base
    type 'a gammacurve_t
...
structure GammaCurve :> GammaCurve = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toGammaCurve obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_gamma_curve_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure HBox :> HBox = struct
    ...
    fun inherit w con = let val con = let val ptr = con () in fn () => ptr end
			...
			in Box.inherit witness con end
    fun make ptr = inherit () (fn () => ptr)
    fun toHBox obj = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_hbox_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : bool * int -> cptr
...
structure Statusbar :> Statusbar = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toStatusbar obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_statusbar_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn context_description =>
	     GObject.withPtr
	       (self, 
		fn self => get_context_id_
			     (self, CString.fromString context_description))
    val push_ : cptr * int * CString.cstring -> int
	= _import "gtk_statusbar_push" : cptr * int * CString.cstring -> int;
    val push : 'a t -> int -> string -> int
	...
	= _import "gtk_statusbar_set_has_resize_grip" : cptr * bool -> unit;
    val set_has_resize_grip : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr
    ...
    in
      val text_pushed_sig : (int -> char -> unit) -> 'a t Signal.signal
	  = fn f => signal "text-pushed" false (int --> char --> return_void) f
      val text_popped_sig : (int -> char -> unit) -> 'a t Signal.signal
	  = fn f => signal "text-popped" false (int --> char --> return_void) f
    end
end
signature Combo = sig
    type base
...
structure Combo :> Combo = struct
    ...
    fun toCombo obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_combo_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_combo_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val set_value_in_list_ : cptr * bool * bool -> unit
	= _import "gtk_combo_set_value_in_list" : cptr * bool * bool -> unit;
    val set_value_in_list : 'a t -> bool -> bool -> unit
	= fn self => fn valu => fn ok_if_empty =>
	     GObject.withPtr
	       (self, fn self => set_value_in_list_ (self, valu, ok_if_empty))
    val set_use_arrows_ : cptr * bool -> unit
	= _import "gtk_combo_set_use_arrows" : cptr * bool -> unit;
    val set_use_arrows : 'a t -> bool -> unit
	= fn self => fn valu =>
	     GObject.withPtr (self, fn self => set_use_arrows_ (self, valu))
		...
		fn self => GObject.withPtr
			     (item, 
			      fn item => set_item_string_
					   (self, item, 
					    CString.fromString item_value)))
    val disable_activate_ : cptr -> unit
	= _import "gtk_combo_disable_activate" : cptr -> unit;
    val disable_activate : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => disable_activate_ self)
end
signature ButtonBox = sig
    type base
    type 'a buttonbox_t
...
structure ButtonBox :> ButtonBox = struct
    type cptr = GObject.cptr
    type base = unit
	...
	= _import "gtk_button_box_set_child_size" : cptr * int * int -> unit;
    val set_child_size : 'a t -> int -> int -> unit
	= fn self => fn min_width => fn min_height =>
	     GObject.withPtr
	       (self, fn self => set_child_size_ (self, min_width, min_height))
	...
	= fn self => fn ipad_x => fn ipad_y =>
	     GObject.withPtr
	       (self, fn self => set_child_ipadding_ (self, ipad_x, ipad_y))
end
signature VButtonBox = sig
    type base
    type 'a vbuttonbox_t
...
structure VButtonBox :> VButtonBox = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toVButtonBox obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_vbutton_box_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure HButtonBox :> HButtonBox = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toHButtonBox obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_hbutton_box_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
signature Calendar = sig
    ...
    val day_selected_double_click_sig : (unit -> unit) -> 'a t Signal.signal
...
structure Calendar :> Calendar = struct
    ...
    val get_type_ : unit -> int
	= _import "gtk_calendar_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val freeze_ : cptr -> unit = _import "gtk_calendar_freeze" : cptr -> unit;
    val freeze : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => freeze_ self)
...
structure Window :> Window = struct
    ...
    fun toWindow obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    type position = int
    val get_position_ : int ref * int ref * int ref * int ref * int ref -> unit
	...
	= let val (x0, x1, x2, x3, x4) = (ref 0, ref 0, ref 0, ref 0, ref 0)
	  in
	    get_position_ (x0, x1, x2, x3, x4); (! x0, ! x1, ! x2, ! x3, ! x4) 
	  end
    type type_t = int
    ...
    val (TOPLEVEL, POPUP) = let val (x0, x1) = (ref 0, ref 0)
			    in get_type_t_ (x0, x1); (! x0, ! x1)  end
    val get_type_ : unit -> int = _import "gtk_window_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val activate_focus : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => activate_focus_ self)
	...
	= fn self =>
	     Widget.inherit
	       () (fn () => GObject.withPtr (self, fn self => get_focus_ self))
    ...
    val activate_default : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => activate_default_ self)
	...
	= _import "gtk_window_set_destroy_with_parent" : cptr * bool -> unit;
    val set_destroy_with_parent : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr
    ...
    val set_decorated : 'a t -> bool -> unit
	= fn self => fn setting =>
	     GObject.withPtr (self, fn self => set_decorated_ (self, setting))
		...
		fn self => GObject.withPtr
			     (target, 
			      fn target => remove_mnemonic_
					     (self, keyval, target)))
    val present_ : cptr -> unit = _import "gtk_window_present" : cptr -> unit;
    val present : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => present_ self)
    val iconify_ : cptr -> unit = _import "gtk_window_iconify" : cptr -> unit;
    val iconify : 'a t -> unit
    ...
    val unstick_ : cptr -> unit = _import "gtk_window_unstick" : cptr -> unit;
    val unstick : 'a t -> unit
	...
	= fn self => fn allow_shrink => fn allow_grow => fn auto_shrink =>
	     GObject.withPtr (self, 
			      fn self => set_policy_ (self, allow_shrink, 
    ...
    val resize : 'a t -> int -> int -> unit
	= fn self => fn width => fn height =>
	     GObject.withPtr (self, fn self => resize_ (self, width, height))
	...
	= _import "gtk_window_parse_geometry" : cptr * CString.cstring -> bool;
    val parse_geometry : 'a t -> string -> bool
	= fn self => fn geometry =>
	     GObject.withPtr
	       (self, 
		fn self => parse_geometry_ (self, CString.fromString geometry))
    ...
    val group_get_type_ : unit -> int
	= _import "gtk_window_group_get_type" : unit -> int;
    val group_get_type : unit -> int = fn dummy => group_get_type_ dummy
    ...
    val add_embedded_xid : 'a t -> int -> unit
	= fn self => fn xid =>
	     GObject.withPtr (self, fn self => add_embedded_xid_ (self, xid))
    local open Signal
	  infixr -->
    in val set_focus_sig : (unit -> unit) -> 'a t Signal.signal
       ...
       val activate_default_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "activate-default" false (void --> return_void) f
       val move_focus_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "move-focus" false (unit --> return_void) f
       val keys_changed_sig : (unit -> unit) -> 'a t Signal.signal
...
structure Plug :> Plug = struct
    ...
    fun make ptr = inherit () (fn () => ptr)
    fun toPlug obj = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int = _import "gtk_plug_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    local open Signal
	  infixr -->
...
structure Dialog :> Dialog = struct
    ...
    val get_type_ : unit -> int = _import "gtk_dialog_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn title => fn parent => fn flags => fn first_button_text =>
	     make (GObject.withOpt
		     (parent, 
		      fn parent =>
			 new_with_buttons_
			   (CString.fromString (getOpt (title, "")), parent, 
	...
	= _import "gtk_dialog_add_action_widget" : cptr * cptr * int -> unit;
    val add_action_widget : 'a t -> 'b Widget.t -> int -> unit
	...
	= _import "gtk_dialog_add_buttons" : cptr * CString.cstring -> unit;
    val add_buttons : 'a t -> string -> unit
    ...
    val get_has_separator : 'a t -> bool
	= fn self => GObject.withPtr (self, fn self => get_has_separator_ self)
    val response_ : cptr * int -> unit
	= _import "gtk_dialog_response" : cptr * int -> unit;
    val response : 'a t -> int -> unit
	= fn self => fn response_id =>
	     GObject.withPtr (self, fn self => response_ (self, response_id))
...
structure MessageDialog :> MessageDialog = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toMessageDialog obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_message_dialog_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
end
signature InputDialog = sig
    type base
...
structure InputDialog :> InputDialog = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toInputDialog obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_input_dialog_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = _import "gtk_input_dialog_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
    local open Signal
	  infixr -->
...
signature FontSelectionDialog = sig
    type base
...
structure FontSelectionDialog :> FontSelectionDialog = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toFontSelectionDialog obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val new_ : CString.cstring -> cptr
	= _import "gtk_font_selection_dialog_new" : CString.cstring -> cptr;
    val new : string -> base t
...
structure FileSelection :> FileSelection = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toFileSelection obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val get_type_ : unit -> int
	= _import "gtk_file_selection_get_type" : unit -> int;
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : CString.cstring -> cptr
	...
	= fn self => fn filename =>
	     GObject.withPtr
	       (self, 
		fn self => set_filename_ (self, CString.fromString filename))
	...
	= fn self => fn pattern =>
	     GObject.withPtr
	       (self, fn self => complete_ (self, CString.fromString pattern))
	...
	= fn self => fn select_multiple =>
	     GObject.withPtr
	       (self, fn self => set_select_multiple_ (self, select_multiple))
...
signature ColorSelectionDialog = sig
    type base
...
structure ColorSelectionDialog :> ColorSelectionDialog = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toColorSelectionDialog obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val new_ : CString.cstring -> cptr
	= _import "gtk_color_selection_dialog_new" : CString.cstring -> cptr;
    val new : string -> base t
	= fn title => make (new_ (CString.fromString title))
end
signature WindowGroup = sig
    type base
...
structure WindowGroup :> WindowGroup = struct
    type cptr = GObject.cptr
    type base = unit
    ...
    fun toWindowGroup obj
      = inherit () (fn () => GObject.withPtr (obj, fn obj => obj))
    val new_ : unit -> cptr = _import "gtk_window_group_new" : unit -> cptr;
    val new : unit -> base t = fn dummy => make (new_ dummy)
...
structure Clipboard :> Clipboard = struct
    type cptr = GObject.cptr
    type base = unit
	...
	= fn self =>
	     GObject.inherit
	       () (fn () => GObject.withPtr (self, fn self => get_owner_ self))
    val clear_ : cptr -> unit = _import "gtk_clipboard_clear" : cptr -> unit;
    val clear : 'a t -> unit
	= fn self => GObject.withPtr (self, fn self => clear_ self)
    val set_text_ : cptr * CString.cstring * int -> unit
