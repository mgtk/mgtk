...
val get_responsetype_
  : unit -> int * int * int * int * int * int * int * int * int * int * int
...
val (CURVE_TYPE_LINEAR, CURVE_TYPE_SPLINE, CURVE_TYPE_FREE) = get_curvetype_ ()
type deletetype = int
...
type scrolltype = int
val get_scrolltype_ : unit -> int * int * int * int * int * int * int * int 
...
val (VISIBILITY_NONE, VISIBILITY_PARTIAL, VISIBILITY_FULL) = get_visibility_ ()
type wrap_mode = int
...
val get_text_window_type_t_ : unit -> int * int * int * int * int * int * int
...
val accel_map_load : string -> unit = fn file_name => accel_map_load_ file_name
val accel_map_save_ : string -> unit = app1 (symb"mgtk_gtk_accel_map_save")
val accel_map_save : string -> unit = fn file_name => accel_map_save_ file_name

val accel_map_load_fd_ : int -> unit = app1 (symb"mgtk_gtk_accel_map_load_fd")
val accel_map_load_fd : int -> unit = fn fd => accel_map_load_fd_ fd
val accel_map_save_fd_ : int -> unit = app1 (symb"mgtk_gtk_accel_map_save_fd")
...
val disable_setlocale_ : unit -> unit = app1 (symb"mgtk_gtk_disable_setlocale")
...
val main_iteration_do_ : bool -> bool = app1 (symb"mgtk_gtk_main_iteration_do")
...
val border_get_type_ : unit -> int = app1 (symb"mgtk_gtk_border_get_type")
...
structure AccelGroup :> AccelGroup = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_accelgroup_get_type")
...
structure IconFactory :> IconFactory = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_icon_factory_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val remove_default : 'a t -> unit = fn self => remove_default_ (repr self)
...
structure Object :> Object = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_object_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : int -> string -> cptr = app2 (symb"mgtk_gtk_object_new")
    val new : int -> string -> base t = fn typ => fn first_property_name =>
...
structure Adjustment :> Adjustment = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_adjustment_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val value_changed : 'a t -> unit = fn self => value_changed_ (repr self)
    ...
    val get_value_ : cptr -> real = app1 (symb"mgtk_gtk_adjustment_get_value")
...
structure Widget :> Widget = struct
    ...
    val drag_highlight_ : cptr -> unit = app1 (symb"mgtk_gtk_drag_highlight")
    val drag_highlight : 'a t -> unit = fn self => drag_highlight_ (repr self)
    val drag_unhighlight_ : cptr -> unit
	= app1 (symb"mgtk_gtk_drag_unhighlight")
    val drag_unhighlight : 'a t -> unit
	= fn self => drag_unhighlight_ (repr self)
    val drag_dest_unset_ : cptr -> unit = app1 (symb"mgtk_gtk_drag_dest_unset")
    val drag_dest_unset : 'a t -> unit
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_widget_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : int -> string -> cptr = app2 (symb"mgtk_gtk_widget_new")
    val new : int -> string -> base t = fn typ => fn first_property_name =>
					   make (new_ typ first_property_name)
    ...
    val set : 'a t -> string -> unit = fn self => fn first_property_name =>
    ...
    val queue_draw_ : cptr -> unit = app1 (symb"mgtk_gtk_widget_queue_draw")
    ...
    val queue_clear_ : cptr -> unit = app1 (symb"mgtk_gtk_widget_queue_clear")
	...
	= app2 (symb"mgtk_gtk_widget_size_request")
    val size_request : 'a t -> requisition -> unit
	= fn self => fn requisition => size_request_ (repr self) requisition
	...
	= fn self => fn hadjustment => fn vadjustment =>
	     set_scroll_adjustments_
	       (repr self) (getOpt (Option.map repr hadjustment, GObject.null))
    ...
    val reparent : 'a t -> 'b t -> unit
	= fn self => fn new_parent => reparent_ (repr self) (repr new_parent)
    ...
    val grab_focus_ : cptr -> unit = app1 (symb"mgtk_gtk_widget_grab_focus")
    ...
    val set_child_visible : 'a t -> bool -> unit
	= fn self => fn is_visible => set_child_visible_ (repr self) is_visible
    val get_child_visible_ : cptr -> bool
	= app1 (symb"mgtk_gtk_widget_get_child_visible")
    val get_child_visible : 'a t -> bool
	= fn self => get_child_visible_ (repr self)
    val get_parent_ : cptr -> cptr = app1 (symb"mgtk_gtk_widget_get_parent")
    val get_parent : 'a t -> base t = fn self => make (get_parent_ (repr self))
    ...
    val is_ancestor : 'a t -> 'b t -> bool
	= fn self => fn ancestor => is_ancestor_ (repr self) (repr ancestor)
    val hide_on_delete_ : cptr -> bool
	= app1 (symb"mgtk_gtk_widget_hide_on_delete")
    val hide_on_delete : 'a t -> bool = fn self => hide_on_delete_ (repr self)
    ...
    val get_style : 'a t -> base t = fn self => make (get_style_ (repr self))
...
structure Editable :> Editable = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_editable_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val select_region_ : cptr -> int -> int -> unit
	= app3 (symb"mgtk_gtk_editable_select_region")
    val select_region : 'a t -> int -> int -> unit
	= fn self => fn start => fn en => select_region_ (repr self) start en
    ...
    val cut_clipboard : 'a t -> unit = fn self => cut_clipboard_ (repr self)
    val copy_clipboard_ : cptr -> unit
	= app1 (symb"mgtk_gtk_editable_copy_clipboard")
    val copy_clipboard : 'a t -> unit = fn self => copy_clipboard_ (repr self)
    ...
    val set_editable : 'a t -> bool -> unit
	= fn self => fn is_editable => set_editable_ (repr self) is_editable
...
structure IMContext :> IMContext = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_im_context_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val focus_in_ : cptr -> unit = app1 (symb"mgtk_gtk_im_context_focus_in")
    val focus_in : 'a t -> unit = fn self => focus_in_ (repr self)
    val focus_out_ : cptr -> unit = app1 (symb"mgtk_gtk_im_context_focus_out")
    ...
    val set_use_preedit : 'a t -> bool -> unit
	= fn self => fn use_preedit => set_use_preedit_ (repr self) use_preedit
...
structure CellRenderer :> CellRenderer = struct
	...
	= get_mode_ ()
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_cellrenderer_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure CellEditable :> CellEditable = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_cell_editable_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val remove_widget : 'a t -> unit = fn self => remove_widget_ (repr self)
end
...
structure CellRendererText :> CellRendererText = struct
	...
	= app2 (symb"mgtk_gtk_cellrenderer_text_set_fixed_height_from_font")
    val set_fixed_height_from_font : 'a t -> int -> unit
...
structure RcStyle :> RcStyle = struct
    ...
    val rc_style_unref_ : cptr -> unit = app1 (symb"mgtk_gtk_rc_style_unref")
    val rc_style_unref : 'a t -> unit = fn self => rc_style_unref_ (repr self)
...
structure Settings :> Settings = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_settings_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure SizeGroup :> SizeGroup = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_size_group_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Style :> Style = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_style_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure TextBuffer :> TextBuffer = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_textbuffer_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_line_count : 'a t -> int = fn self => get_line_count_ (repr self)
    val get_char_count_ : cptr -> int
	= app1 (symb"mgtk_gtk_textbuffer_get_char_count")
    val get_char_count : 'a t -> int = fn self => get_char_count_ (repr self)
    ...
    val insert_interactive_at_cursor_ : cptr -> string -> int -> bool -> bool
	...
	= fn self => fn iter => fn text => fn len => fn first_tag_name =>
	     insert_with_tags_by_name_ (repr self) iter text len first_tag_name
    ...
    val get_text' : 'a t -> textiter -> textiter -> string
	= fn self => fn start => fn en => get_text_ (repr self) start en true
	...
	= fn self => fn start => fn en => fn include_hidden_chars =>
	     get_slice_ (repr self) start en
		        (getOpt (include_hidden_chars, true))
    val get_slice' : 'a t -> textiter -> textiter -> string
	= fn self => fn start => fn en => get_slice_ (repr self) start en true
    ...
    val create_child_anchor : 'a t -> textiter -> base t
	= fn self => fn iter => make (create_child_anchor_ (repr self) iter)
    ...
    val create_mark' : 'a t -> textiter -> base t
	= fn self => fn wher => make (create_mark_ (repr self) "" wher false)
    ...
    val get_insert : 'a t -> base t = fn self => make (get_insert_ (repr self))
    ...
    val remove_all_tags : 'a t -> textiter -> textiter -> unit
	= fn self => fn start => fn en => remove_all_tags_ (repr self) start en
	...
	= fn self => fn iter => fn line_number => fn char_offset =>
	     getiter_at_line_offset_ (repr self) iter line_number char_offset
...
structure TextMark :> TextMark = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_textmark_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_name_ : cptr -> string = app1 (symb"mgtk_gtk_textmark_get_name")
    val get_name : 'a t -> string = fn self => get_name_ (repr self)
    val get_deleted_ : cptr -> bool
	= app1 (symb"mgtk_gtk_textmark_get_deleted")
    val get_deleted : 'a t -> bool = fn self => get_deleted_ (repr self)
    val get_buffer_ : cptr -> cptr = app1 (symb"mgtk_gtk_textmark_get_buffer")
    val get_buffer : 'a t -> base TextBuffer.t
	= fn self => TextBuffer.inherit () (fn () => get_buffer_ (repr self))
...
structure TextTag :> TextTag = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_text_tag_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure TextTagTable :> TextTagTable = struct
    ...
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val add_ : cptr -> cptr -> unit = app2 (symb"mgtk_gtk_text_tag_table_add")
    val add : 'a t -> 'b t -> unit
    ...
    val get_size_ : cptr -> int = app1 (symb"mgtk_gtk_text_tag_table_get_size")
...
structure Tooltips :> Tooltips = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_tooltips_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure TreeModel :> TreeModel = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_treemodel_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val get_flags_ : cptr -> int = app1 (symb"mgtk_gtk_treemodel_get_flags")
    val get_flags : 'a t -> flags list
    ...
    val getiter : 'a t -> treeiter -> tree_path -> bool
	= fn self => fn iter => fn path => getiter_ (repr self) iter path
	...
	= fn self => fn iter => fn parent => fn n =>
	     iter_nth_child_ (repr self) iter (getOpt (parent, GObject.null)) n
    val iter_nth_child' : 'a t -> treeiter -> int -> bool
	= fn self => fn iter => fn n =>
	     iter_nth_child_ (repr self) iter GObject.null n
    ...
    val row_changed : 'a t -> tree_path -> treeiter -> unit
	= fn self => fn path => fn iter => row_changed_ (repr self) path iter
    val row_inserted_ : cptr -> cptr -> cptr -> unit
	= app3 (symb"mgtk_gtk_treemodel_row_inserted")
    val row_inserted : 'a t -> tree_path -> treeiter -> unit
	= fn self => fn path => fn iter => row_inserted_ (repr self) path iter
...
structure TreeDragDest :> TreeDragDest = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_tree_drag_dest_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure TreeSortable :> TreeSortable = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_tree_sortable_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure TreeModelSort :> TreeModelSort = struct
    ...
    val get_model : 'a t -> base t = fn self => make (get_model_ (repr self))
	...
	= fn self => fn sort_iter => fn child_iter =>
	     convert_childiter_toiter_
	       (repr self) (getOpt (sort_iter, GObject.null)) child_iter
    val convert_childiter_toiter' : 'a t -> treeiter -> unit
	= fn self => fn child_iter =>
	     convert_childiter_toiter_ (repr self) GObject.null child_iter
	...
	= fn self => fn child_iter => fn sorted_iter =>
	     convertiter_to_childiter_
	       (repr self) (getOpt (child_iter, GObject.null)) sorted_iter
    val convertiter_to_childiter' : 'a t -> treeiter -> unit
	= fn self => fn sorted_iter =>
	     convertiter_to_childiter_ (repr self) GObject.null sorted_iter
...
structure TreeSelection :> TreeSelection = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_treeselection_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val set_mode_ : cptr -> int -> unit
	= app2 (symb"mgtk_gtk_treeselection_set_mode")
    val set_mode : 'a t -> selection_mode -> unit
	= fn self => fn typ => set_mode_ (repr self) typ
    val get_mode_ : cptr -> int = app1 (symb"mgtk_gtk_treeselection_get_mode")
    val get_mode : 'a t -> selection_mode = fn self => get_mode_ (repr self)
    val get_user_data_ : cptr -> cptr
	= app1 (symb"mgtk_gtk_treeselection_get_user_data")
    val get_user_data : 'a t -> cptr = fn self => get_user_data_ (repr self)
	...
	= fn self => fn model => fn iter =>
	     get_selected_ (repr self) (repr model) iter
...
structure TreeStore :> TreeStore = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_tree_store_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn iter => fn parent => fn position =>
	     insert_ (repr self) iter parent position
...
structure TreeViewColumn :> TreeViewColumn = struct
	...
	= get_sizing_ ()
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_treeviewcolumn_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val new_with_attributes : string -> 'a CellRenderer.t -> base t
	= fn title => fn cell => make (new_with_attributes_ title (repr cell))
	...
	= fn self => fn cell_renderer => fn attribute => fn column =>
	     add_attribute_ (repr self) (repr cell_renderer) attribute column
    ...
    val get_resizable : 'a t -> bool = fn self => get_resizable_ (repr self)
    ...
    val get_fixed_width : 'a t -> int = fn self => get_fixed_width_ (repr self)
    val set_fixed_width_ : cptr -> int -> unit
	= app2 (symb"mgtk_gtk_treeviewcolumn_set_fixed_width")
    val set_fixed_width : 'a t -> int -> unit
	= fn self => fn fixed_width => set_fixed_width_ (repr self) fixed_width
    ...
    val clicked_ : cptr -> unit = app1 (symb"mgtk_gtk_treeviewcolumn_clicked")
    ...
    val get_clickable : 'a t -> bool = fn self => get_clickable_ (repr self)
    ...
    val get_alignment : 'a t -> real = fn self => get_alignment_ (repr self)
    val set_reorderable_ : cptr -> bool -> unit
	= app2 (symb"mgtk_gtk_treeviewcolumn_set_reorderable")
    val set_reorderable : 'a t -> bool -> unit
	= fn self => fn reorderable => set_reorderable_ (repr self) reorderable
	...
	= fn self => fn tree_model => fn iter => fn is_expander => 
	  fn is_expanded =>
	     cell_set_cell_data_
	       (repr self) (repr tree_model) iter is_expander is_expanded
...
structure Separator :> Separator = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_separator_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure VSeparator :> VSeparator = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_vseparator_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure HSeparator :> HSeparator = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_hseparator_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Ruler :> Ruler = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_ruler_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_metric : 'a t -> metrictype = fn self => get_metric_ (repr self)
end
...
structure VRuler :> VRuler = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_vruler_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure HRuler :> HRuler = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_hruler_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Range :> Range = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_range_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_inverted_ : cptr -> bool = app1 (symb"mgtk_gtk_range_get_inverted")
...
structure Scrollbar :> Scrollbar = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_scrollbar_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
end
...
structure VScrollbar :> VScrollbar = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_vscrollbar_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure HScrollbar :> HScrollbar = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_hscrollbar_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Scale :> Scale = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_scale_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_draw_value : 'a t -> bool -> unit
	= fn self => fn draw_value => set_draw_value_ (repr self) draw_value
    val get_draw_value_ : cptr -> bool
	= app1 (symb"mgtk_gtk_scale_get_draw_value")
    val get_draw_value : 'a t -> bool = fn self => get_draw_value_ (repr self)
...
structure VScale :> VScale = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_vscale_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val new_with_range : real -> real -> real -> base t
	= fn min => fn max => fn step => make (new_with_range_ min max step)
end
...
structure HScale :> HScale = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_hscale_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Progress :> Progress = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_progress_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_percentage : 'a t -> real -> unit
	= fn self => fn percentage => set_percentage_ (repr self) percentage
    val set_value_ : cptr -> real -> unit
	= app2 (symb"mgtk_gtk_progress_set_value")
    val set_value : 'a t -> real -> unit
	= fn self => fn value => set_value_ (repr self) value
    val get_value_ : cptr -> real = app1 (symb"mgtk_gtk_progress_get_value")
    val get_value : 'a t -> real = fn self => get_value_ (repr self)
    ...
    val get_percentage_from_value : 'a t -> real -> real
	= fn self => fn value => get_percentage_from_value_ (repr self) value
end
...
structure ProgressBar :> ProgressBar = struct
	...
	= get_orientation_ ()
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_progressbar_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_orientation : 'a t -> orientation -> unit
	= fn self => fn orientation => set_orientation_ (repr self) orientation
    val get_text_ : cptr -> string = app1 (symb"mgtk_gtk_progressbar_get_text")
    ...
    val get_pulse_step : 'a t -> real = fn self => get_pulse_step_ (repr self)
...
structure Preview :> Preview = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_preview_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val size_ : cptr -> int -> int -> unit = app3 (symb"mgtk_gtk_preview_size")
    val size : 'a t -> int -> int -> unit
	= fn self => fn width => fn height => size_ (repr self) width height
...
structure OldEditable :> OldEditable = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_old_editable_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val changed_ : cptr -> unit = app1 (symb"mgtk_gtk_old_editable_changed")
    val changed : 'a t -> unit = fn self => changed_ (repr self)
end
signature Misc = sig
    type base
...
structure Misc :> Misc = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_misc_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_padding : 'a t -> int -> int -> unit
	= fn self => fn xpad => fn ypad => set_padding_ (repr self) xpad ypad
end
...
structure Pixmap :> Pixmap = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_pixmap_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Arrow :> Arrow = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_arrow_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : int -> int -> cptr = app2 (symb"mgtk_gtk_arrow_new")
    val new : arrowtype -> shadowtype -> base t
	= fn arrow_type => fn shadow_type => make (new_ arrow_type shadow_type)
...
structure Image :> Image = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_image_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Label :> Label = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_label_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_use_markup : 'a t -> bool = fn self => get_use_markup_ (repr self)
    ...
    val get_justify_ : cptr -> int = app1 (symb"mgtk_gtk_label_get_justify")
    val get_justify : 'a t -> justification
    ...
    val get_line_wrap : 'a t -> bool = fn self => get_line_wrap_ (repr self)
    ...
    val get_selectable : 'a t -> bool = fn self => get_selectable_ (repr self)
    val select_region_ : cptr -> int -> int -> unit
...
structure AccelLabel :> AccelLabel = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_accel_label_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_accel_widget : 'a t -> base Widget.t
	= fn self => Widget.inherit () (fn () => get_accel_widget_ (repr self))
    val get_accel_width_ : cptr -> int
	= app1 (symb"mgtk_gtk_accel_label_get_accel_width")
    val get_accel_width : 'a t -> int = fn self => get_accel_width_ (repr self)
...
structure Invisible :> Invisible = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_invisible_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Entry :> Entry = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_entry_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_visibility : 'a t -> bool = fn self => get_visibility_ (repr self)
    ...
    val get_has_frame : 'a t -> bool = fn self => get_has_frame_ (repr self)
    ...
    val get_max_length : 'a t -> int = fn self => get_max_length_ (repr self)
    val set_activates_default_ : cptr -> bool -> unit
	= app2 (symb"mgtk_gtk_entry_set_activates_default")
    val set_activates_default : 'a t -> bool -> unit
	= fn self => fn setting => set_activates_default_ (repr self) setting
    ...
    val get_width_chars : 'a t -> int = fn self => get_width_chars_ (repr self)
    val set_text_ : cptr -> string -> unit
...
structure SpinButton :> SpinButton = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_spin_button_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_range : 'a t -> real -> real -> unit
	= fn self => fn min => fn max => set_range_ (repr self) min max
    val get_value_ : cptr -> real = app1 (symb"mgtk_gtk_spin_button_get_value")
    val get_value : 'a t -> real = fn self => get_value_ (repr self)
    ...
    val get_wrap_ : cptr -> bool = app1 (symb"mgtk_gtk_spin_button_get_wrap")
...
structure DrawingArea :> DrawingArea = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_drawing_area_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Curve :> Curve = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_curve_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Container :> Container = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_container_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val remove_ : cptr -> cptr -> unit = app2 (symb"mgtk_gtk_container_remove")
    val remove : 'a t -> 'b Widget.t -> unit
    ...
    val set_resize_mode : 'a t -> resize_mode -> unit
	= fn self => fn resize_mode => set_resize_mode_ (repr self) resize_mode
    ...
    val childtype_ : cptr -> int = app1 (symb"mgtk_gtk_container_childtype")
    val childtype : 'a t -> int = fn self => childtype_ (repr self)
...
structure TreeView :> TreeView = struct
	...
	= get_drop_position_ ()
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_treeview_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val new_with_model : 'a TreeModel.t option -> base t
	= fn model => make (new_with_model_ (getOpt (Option.map repr model, 
						     GObject.null)))
    val new_with_model' : unit -> base t
	= fn dummy => make (new_with_model_ GObject.null)
    val get_model_ : cptr -> cptr = app1 (symb"mgtk_gtk_treeview_get_model")
    val get_model : 'a t -> base TreeModel.t
    ...
    val get_rules_hint : 'a t -> bool = fn self => get_rules_hint_ (repr self)
    ...
    val insert_column_with_attributes_ : cptr -> int -> string -> cptr -> int
	...
	= fn self => fn column => fn base_column =>
	     move_column_after_ (repr self) (repr column) (repr base_column)
	...
	= fn self => fn path => fn column => fn use_align => fn row_align => 
	  fn col_align =>
	     scroll_to_cell_ (repr self, path, 
			      getOpt (Option.map repr column, GObject.null), 
			      getOpt (use_align, false), 
			      getOpt (row_align, 0.0), getOpt (col_align, 0.0))
    val scroll_to_cell' : 'a t -> tree_path -> unit
	= fn self => fn path =>
	     scroll_to_cell_ (repr self, path, GObject.null, false, 0.0, 0.0)
    ...
    val expand_all_ : cptr -> unit = app1 (symb"mgtk_gtk_treeview_expand_all")
    ...
    val set_cursor' : 'a t -> tree_path -> unit
	= fn self => fn path => set_cursor_ (repr self) path GObject.null false
    val get_cursor_ : cptr -> cptr -> cptr -> unit
	= app3 (symb"mgtk_gtk_treeview_get_cursor")
    val get_cursor : 'a t -> tree_path -> 'b TreeViewColumn.t -> unit
	= fn self => fn path => fn focus_column =>
	     get_cursor_ (repr self) path (repr focus_column)
...
structure Toolbar :> Toolbar = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_toolbar_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val prepend_space : 'a t -> unit = fn self => prepend_space_ (repr self)
    ...
    val unset_style_ : cptr -> unit = app1 (symb"mgtk_gtk_toolbar_unset_style")
...
structure TextView :> TextView = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_textview_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val new_withbuffer : 'a TextBuffer.t option -> base t
	= fn buffer => make (new_withbuffer_ (getOpt (Option.map repr buffer, 
						      GObject.null)))
    val new_withbuffer' : unit -> base t
    ...
    val get_buffer_ : cptr -> cptr = app1 (symb"mgtk_gtk_textview_get_buffer")
    val get_buffer : 'a t -> base TextBuffer.t
	= fn self => TextBuffer.inherit () (fn () => get_buffer_ (repr self))
	...
	= fn self => fn iter => fn within_margin => fn use_align => 
	  fn xalign => fn yalign =>
	     scroll_toiter_
	       (repr self, iter, within_margin, getOpt (use_align, false), 
		getOpt (xalign, 0.5), getOpt (yalign, 0.5))
    val scroll_toiter' : 'a t -> textiter -> real -> bool
	= fn self => fn iter => fn within_margin =>
	     scroll_toiter_ (repr self, iter, within_margin, false, 0.5, 0.5)
	...
	= fn self => fn mark => fn within_margin => fn use_align => 
	  fn xalign => fn yalign =>
	     scroll_to_mark_ (repr self, repr mark, within_margin, 
			      getOpt (use_align, false), getOpt (xalign, 0.5), 
			      getOpt (yalign, 0.5))
    val scroll_to_mark' : 'a t -> 'b TextMark.t -> real -> unit
    ...
    val scroll_mark_onscreen : 'a t -> 'b TextMark.t -> unit
	= fn self => fn mark => scroll_mark_onscreen_ (repr self) (repr mark)
	...
	= fn self => fn iter => fn x => fn y =>
	     getiter_at_location_ (repr self) iter x y
    ...
    val backward_display_line_start : 'a t -> textiter -> bool
	= fn self => fn iter => backward_display_line_start_ (repr self) iter
    ...
    val set_left_margin : 'a t -> int -> unit
	= fn self => fn left_margin => set_left_margin_ (repr self) left_margin
    val get_left_margin_ : cptr -> int
	= app1 (symb"mgtk_gtk_textview_get_left_margin")
    val get_left_margin : 'a t -> int = fn self => get_left_margin_ (repr self)
    ...
    val get_indent_ : cptr -> int = app1 (symb"mgtk_gtk_textview_get_indent")
...
structure Table :> Table = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_table_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val resize : 'a t -> int -> int -> unit
	= fn self => fn rows => fn columns => resize_ (repr self) rows columns
    ...
    val set_homogeneous : 'a t -> bool -> unit
	= fn self => fn homogeneous => set_homogeneous_ (repr self) homogeneous
...
structure Socket :> Socket = struct
    ...
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_socket_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    local open Signal
	  infixr -->
...
structure Paned :> Paned = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_paned_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_position_ : cptr -> int = app1 (symb"mgtk_gtk_paned_get_position")
    val get_position : 'a t -> int = fn self => get_position_ (repr self)
    val set_position_ : cptr -> int -> unit
...
structure VPaned :> VPaned = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_vpaned_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure HPaned :> HPaned = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_hpaned_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Notebook :> Notebook = struct
    ...
    type tab = int
    val get_tab_ : unit -> int * int = app1 (symb"mgtk_get_gtk_notebook_tab")
    val (TAB_FIRST, TAB_LAST) = get_tab_ ()
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_notebook_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn child => fn tab_label => fn position =>
	     insert_page_ (repr self) (repr child) (repr tab_label) position
    ...
    val get_nth_page : 'a t -> int -> base Widget.t
	= fn self => fn page_num =>
	     Widget.inherit () (fn () => get_nth_page_ (repr self) page_num)
    ...
    val next_page_ : cptr -> unit = app1 (symb"mgtk_gtk_notebook_next_page")
    val next_page : 'a t -> unit = fn self => next_page_ (repr self)
    val prev_page_ : cptr -> unit = app1 (symb"mgtk_gtk_notebook_prev_page")
    ...
    val set_show_border : 'a t -> bool -> unit
	= fn self => fn show_border => set_show_border_ (repr self) show_border
    ...
    val get_show_tabs : 'a t -> bool = fn self => get_show_tabs_ (repr self)
    val set_tab_pos_ : cptr -> int -> unit
	= app2 (symb"mgtk_gtk_notebook_set_tab_pos")
    val set_tab_pos : 'a t -> positiontype -> unit
	= fn self => fn pos => set_tab_pos_ (repr self) pos
    val get_tab_pos_ : cptr -> int = app1 (symb"mgtk_gtk_notebook_get_tab_pos")
    val get_tab_pos : 'a t -> positiontype
    ...
    val set_tab_hborder : 'a t -> int -> unit
	= fn self => fn tab_hborder => set_tab_hborder_ (repr self) tab_hborder
    val set_tab_vborder_ : cptr -> int -> unit
	= app2 (symb"mgtk_gtk_notebook_set_tab_vborder")
    val set_tab_vborder : 'a t -> int -> unit
	= fn self => fn tab_vborder => set_tab_vborder_ (repr self) tab_vborder
    val set_scrollable_ : cptr -> bool -> unit
	= app2 (symb"mgtk_gtk_notebook_set_scrollable")
    val set_scrollable : 'a t -> bool -> unit
	= fn self => fn scrollable => set_scrollable_ (repr self) scrollable
    val get_scrollable_ : cptr -> bool
	= app1 (symb"mgtk_gtk_notebook_get_scrollable")
    val get_scrollable : 'a t -> bool = fn self => get_scrollable_ (repr self)
    ...
    val popup_disable : 'a t -> unit = fn self => popup_disable_ (repr self)
    ...
    val get_tab_label_text : 'a t -> 'b Widget.t -> string
	= fn self => fn child => get_tab_label_text_ (repr self) (repr child)
    ...
    val get_menu_label_text : 'a t -> 'b Widget.t -> string
	= fn self => fn child => get_menu_label_text_ (repr self) (repr child)
...
structure MenuShell :> MenuShell = struct
    ...
    val select_item : 'a t -> 'b Widget.t -> unit
	= fn self => fn menu_item => select_item_ (repr self) (repr menu_item)
    val deselect_ : cptr -> unit = app1 (symb"mgtk_gtk_menu_shell_deselect")
...
structure Menu :> Menu = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_menu_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_accel_path : 'a t -> string -> unit
	= fn self => fn accel_path => set_accel_path_ (repr self) accel_path
	...
	= fn self => fn child => fn position =>
	     reorder_child_ (repr self) (repr child) position
    val bar_get_type_ : unit -> int = app1 (symb"mgtk_gtk_menu_bar_get_type")
    val bar_get_type : unit -> int = fn dummy => bar_get_type_ dummy
    val item_get_type_ : unit -> int = app1 (symb"mgtk_gtk_menu_item_get_type")
...
structure List :> List = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_list_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val end_selection : 'a t -> unit = fn self => end_selection_ (repr self)
    val select_all_ : cptr -> unit = app1 (symb"mgtk_gtk_list_select_all")
    val select_all : 'a t -> unit = fn self => select_all_ (repr self)
    val unselect_all_ : cptr -> unit = app1 (symb"mgtk_gtk_list_unselect_all")
    val unselect_all : 'a t -> unit = fn self => unselect_all_ (repr self)
    ...
    val undo_selection : 'a t -> unit = fn self => undo_selection_ (repr self)
    val end_drag_selection_ : cptr -> unit
	= app1 (symb"mgtk_gtk_list_end_drag_selection")
    val end_drag_selection : 'a t -> unit
	= fn self => end_drag_selection_ (repr self)
    val item_get_type_ : unit -> int = app1 (symb"mgtk_gtk_list_item_get_type")
    val item_get_type : unit -> int = fn dummy => item_get_type_ dummy
...
structure Layout :> Layout = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_layout_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : cptr -> cptr -> cptr = app2 (symb"mgtk_gtk_layout_new")
    val new : 'a Adjustment.t option -> 'b Adjustment.t option -> base t
	= fn hadjustment => fn vadjustment =>
	     make (new_ (getOpt (Option.map repr hadjustment, GObject.null))
		        (getOpt (Option.map repr vadjustment, GObject.null)))
    val new' : unit -> base t
	...
	= fn self => fn adjustment =>
	     set_hadjustment_
	       (repr self) (getOpt (Option.map repr adjustment, GObject.null))
    val set_hadjustment' : 'a t -> unit
...
structure Fixed :> Fixed = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_fixed_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_has_window : 'a t -> bool -> unit
	= fn self => fn has_window => set_has_window_ (repr self) has_window
    val get_has_window_ : cptr -> bool
	= app1 (symb"mgtk_gtk_fixed_get_has_window")
    val get_has_window : 'a t -> bool = fn self => get_has_window_ (repr self)
end
signature Bin = sig
    type base
    type 'a bin_t
...
structure Bin :> Bin = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_bin_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Viewport :> Viewport = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_viewport_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure ScrolledWindow :> ScrolledWindow = struct
    ...
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : cptr -> cptr -> cptr = app2 (symb"mgtk_gtk_scrolled_window_new")
    val new : 'a Adjustment.t option -> 'b Adjustment.t option -> base t
	= fn hadjustment => fn vadjustment =>
	     make (new_ (getOpt (Option.map repr hadjustment, GObject.null))
		        (getOpt (Option.map repr vadjustment, GObject.null)))
    ...
    val add_with_viewport : 'a t -> 'b Widget.t -> unit
	= fn self => fn child => add_with_viewport_ (repr self) (repr child)
    local open Signal
	  infixr -->
...
structure Item :> Item = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_item_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure MenuItem :> MenuItem = struct
    ...
    val remove_submenu : 'a t -> unit = fn self => remove_submenu_ (repr self)
    ...
    val right_justify : 'a t -> unit = fn self => right_justify_ (repr self)
    local open Signal
	  infixr -->
    in
      val activate_sig : (unit -> unit) -> 'a t Signal.signal
...
structure CheckMenuItem :> CheckMenuItem = struct
    ...
    val get_active : 'a t -> bool = fn self => get_active_ (repr self)
    val toggled_ : cptr -> unit = app1 (symb"mgtk_gtk_check_menu_item_toggled")
...
structure HandleBox :> HandleBox = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_handle_box_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_handle_position : 'a t -> positiontype -> unit
	= fn self => fn position => set_handle_position_ (repr self) position
...
structure Frame :> Frame = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_frame_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_label : 'a t -> string option -> unit
	= fn self => fn label => set_label_ (repr self) (getOpt (label, ""))
    ...
    val get_label_widget : 'a t -> base Widget.t
	= fn self => Widget.inherit () (fn () => get_label_widget_ (repr self))
...
structure AspectFrame :> AspectFrame = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_aspect_frame_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure EventBox :> EventBox = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_event_box_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Alignment :> Alignment = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_alignment_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Button :> Button = struct
	...
	= get_box_style_ ()
    val box_get_type_ : unit -> int = app1 (symb"mgtk_gtk_button_box_get_type")
    ...
    val get_relief : 'a t -> relief_style = fn self => get_relief_ (repr self)
    val set_label_ : cptr -> string -> unit
	= app2 (symb"mgtk_gtk_button_set_label")
    val set_label : 'a t -> string -> unit
	= fn self => fn label => set_label_ (repr self) label
    val get_label_ : cptr -> string = app1 (symb"mgtk_gtk_button_get_label")
    val get_label : 'a t -> string = fn self => get_label_ (repr self)
    val set_use_underline_ : cptr -> bool -> unit
    ...
    val get_use_stock : 'a t -> bool = fn self => get_use_stock_ (repr self)
    local open Signal
	  infixr -->
    in val clicked_sig : (unit -> unit) -> 'a t Signal.signal
	   = fn f => signal "clicked" false (void --> return_void) f
...
structure ToggleButton :> ToggleButton = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_toggle_button_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_mode : 'a t -> bool -> unit
	= fn self => fn draw_indicator => set_mode_ (repr self) draw_indicator
    val get_mode_ : cptr -> bool = app1 (symb"mgtk_gtk_toggle_button_get_mode")
    ...
    val get_active : 'a t -> bool = fn self => get_active_ (repr self)
    val toggled_ : cptr -> unit = app1 (symb"mgtk_gtk_toggle_button_toggled")
    val toggled : 'a t -> unit = fn self => toggled_ (repr self)
    val set_inconsistent_ : cptr -> bool -> unit
...
structure CheckButton :> CheckButton = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_check_button_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure RadioButton :> RadioButton = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_radio_button_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure OptionMenu :> OptionMenu = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_option_menu_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    val new_ : unit -> cptr = app1 (symb"mgtk_gtk_option_menu_new")
    val new : unit -> base t = fn dummy => make (new_ dummy)
    val get_menu_ : cptr -> cptr = app1 (symb"mgtk_gtk_option_menu_get_menu")
    val get_menu : 'a t -> base Widget.t
...
structure Box :> Box = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_box_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
	...
	= fn self => fn child => fn expand => fn fill => fn padding =>
	     pack_end_ (repr self) (repr child) (getOpt (expand, true))
		       (getOpt (fill, true)) (getOpt (padding, 0))
    val pack_end' : 'a t -> 'b Widget.t -> unit
	= fn self => fn child => pack_end_ (repr self) (repr child) true true 0
    ...
    val pack_end_defaults : 'a t -> 'b Widget.t -> unit
	= fn self => fn widget => pack_end_defaults_ (repr self) (repr widget)
    val set_homogeneous_ : cptr -> bool -> unit
	...
	= fn self => fn child => fn expand => fn fill => fn padding => 
	  fn pack_type =>
	     set_child_packing_
	       (repr self, repr child, expand, fill, padding, pack_type)
end
signature VBox = sig
    type base
    type 'a vbox_t
...
structure VBox :> VBox = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_vbox_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure ColorSelection :> ColorSelection = struct
    ...
    val set_has_palette : 'a t -> bool -> unit
	= fn self => fn has_palette => set_has_palette_ (repr self) has_palette
...
structure FontSelection :> FontSelection = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_font_selection_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_font_name : 'a t -> string = fn self => get_font_name_ (repr self)
...
structure GammaCurve :> GammaCurve = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_gamma_curve_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure HBox :> HBox = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_hbox_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Statusbar :> Statusbar = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_statusbar_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Combo :> Combo = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_combo_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure VButtonBox :> VButtonBox = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_vbutton_box_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure HButtonBox :> HButtonBox = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_hbutton_box_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure Calendar :> Calendar = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_calendar_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val display_options : 'a t -> display_options list -> unit
	= fn self => fn flags => display_options_ (repr self) (Flags.set flags)
...
structure Window :> Window = struct
	...
	= get_position_ ()
    type type_t = int
    val get_type_t_ : unit -> int * int = app1 (symb"mgtk_get_gtk_window_type")
    val (TOPLEVEL, POPUP) = get_type_t_ ()
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_window_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val set_title : 'a t -> string -> unit
	= fn self => fn title => set_title_ (repr self) title
    val get_title_ : cptr -> string = app1 (symb"mgtk_gtk_window_get_title")
    val get_title : 'a t -> string = fn self => get_title_ (repr self)
    ...
    val activate_focus : 'a t -> bool = fn self => activate_focus_ (repr self)
    ...
    val set_destroy_with_parent : 'a t -> bool -> unit
	= fn self => fn setting => set_destroy_with_parent_ (repr self) setting
    ...
    val get_decorated : 'a t -> bool = fn self => get_decorated_ (repr self)
    ...
    val unmaximize_ : cptr -> unit = app1 (symb"mgtk_gtk_window_unmaximize")
    ...
    val resize : 'a t -> int -> int -> unit
	= fn self => fn width => fn height => resize_ (repr self) width height
    val move_ : cptr -> int -> int -> unit = app3 (symb"mgtk_gtk_window_move")
    val move : 'a t -> int -> int -> unit
...
structure Plug :> Plug = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_plug_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    local open Signal
	  infixr -->
...
structure Dialog :> Dialog = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_dialog_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val response_ : cptr -> int -> unit = app2 (symb"mgtk_gtk_dialog_response")
    val response : 'a t -> int -> unit
...
structure MessageDialog :> MessageDialog = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_message_dialog_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
end
...
structure InputDialog :> InputDialog = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_input_dialog_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
...
structure FontSelectionDialog :> FontSelectionDialog = struct
    ...
    val new_ : string -> cptr = app1 (symb"mgtk_gtk_font_selection_dialog_new")
...
structure FileSelection :> FileSelection = struct
    ...
    val get_type_ : unit -> int = app1 (symb"mgtk_gtk_file_selection_get_type")
    val get_type : unit -> int = fn dummy => get_type_ dummy
    ...
    val get_filename : 'a t -> string = fn self => get_filename_ (repr self)
...
structure Clipboard :> Clipboard = struct
    ...
    val get_owner_ : cptr -> cptr = app1 (symb"mgtk_gtk_clipboard_get_owner")
    val get_owner : 'a t -> base GObject.t
    ...
    val wait_for_text : 'a t -> string = fn self => wait_for_text_ (repr self)
