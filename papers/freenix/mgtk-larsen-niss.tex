...
denotes the cons operation on lists.  That is, to add an element \textit{x}
to the beginning of a list \textit{xs} we write $\textit{x} \texttt{::}
\textit{xs}$ (in contrast to C++ where double-colon is the module operator).  
