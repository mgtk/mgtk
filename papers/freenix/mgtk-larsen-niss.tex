...
\begin{abstract}
  ...
  \mgtk binding is machine generated, in order to best
...
\classname{Container} and a widget: it returns !unit! as result.
...
\classname{Window} and a string: it returns !unit!.
