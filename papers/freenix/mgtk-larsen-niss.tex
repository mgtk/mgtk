...
\cite{LGPL:1999} graphical toolkit for the X Window System. It
provides facilities for programmers to create graphical user
interfaces.  \gtk is implemented in C with an object-oriented
hierarchy of user interface elements (``widgets''), but from the
beginning the \gtk developers have paid attention to making it
feasible and practical to develop ``bindings'' or ``wrappers'' for
